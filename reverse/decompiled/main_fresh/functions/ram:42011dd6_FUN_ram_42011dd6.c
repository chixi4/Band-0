...

{
  ...
  if (-1 < (int)(param_1 << 1)) goto LAB_ram_42011ece;
  uVar5 = _DAT_ram_60008844 >> 0x19 & 7;
  if ((_DAT_ram_60008844 >> 0x1c & 3) == 0) goto LAB_ram_42011e7e;
  if ((_DAT_ram_60008830 >> 0x1c & 1) != 0) goto LAB_ram_42011e82;
  do {
    FUN_ram_4039bf1e();
    uVar5 = extraout_a5;
LAB_ram_42011e7e:
...
LAB_ram_42011ece:
    if ((_DAT_ram_60008844 >> 0x1c & 3) == 0) {
      if ((_DAT_ram_60008844 >> 0x19 & 7) == 0) goto LAB_ram_42012148;
      goto LAB_ram_42011ee6;
    }
