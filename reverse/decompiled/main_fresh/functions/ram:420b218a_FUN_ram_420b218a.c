...
int FUN_ram_420b218a(int param_1,uint param_2,int param_3)

{
  ...
  if (*(short *)(param_1 + 0x10) != 0) {
    ...
    if (*(ushort *)(param_1 + 0x10) <= *(ushort *)(param_1 + 0xe)) {
      *(short *)(uVar3 * 0xc + 0x3fcc4672) = *(short *)(uVar3 * 0xc + 0x3fcc4672) + 1;
      goto LAB_ram_420b21f0;
    }
    *(ushort *)(param_1 + 0xe) = *(ushort *)(param_1 + 0xe) + 1;
    uVar2 = _DAT_ram_3fcdfdb4;
    piVar6 = (int *)(uVar3 * 0xc + 0x3fcc4668);
    *piVar6 = *piVar6 + 1;
    (**(code **)(_DAT_ram_3fcdfdd8 + 0x58))(uVar2);
  }
  if (uVar3 < 10) {
    if (uVar3 < 7) {
      if (3 < (uVar3 - 1 & 0xff)) goto LAB_ram_420b22f4;
LAB_ram_420b2236:
    ...
    if (uVar3 == 10) goto LAB_ram_420b2236;
LAB_ram_420b22f4:
    iVar4 = FUN_ram_4209393e(uVar3);
  }
  if (iVar4 != 0) {
    ...
    *(byte *)(iVar4 + 0x1a) = bVar1;
    ...
    FUN_ram_4039c11e(iVar5 + uVar8,param_3,param_2);
    return iVar4;
  }
  if (*(short *)(param_1 + 0x10) == 0) {
    return 0;
  ...
  *(short *)(uVar3 * 0xc + 0x3fcc4670) = *(short *)(uVar3 * 0xc + 0x3fcc4670) + 1;
LAB_ram_420b21f0:
