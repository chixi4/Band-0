...
void FUN_ram_4207160c(int param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
                     undefined4 param_5)

{
  ...
  *(undefined4 *)(param_1 + 0x13c) = param_3;
  ...
  iVar2 = FUN_ram_42066b02(param_1 + 0x20,auStack_40,0x100);
  if (iVar2 == 0) {
    FUN_ram_420714aa(param_1,param_4,param_5,uVar1);
  }
  return;
}
