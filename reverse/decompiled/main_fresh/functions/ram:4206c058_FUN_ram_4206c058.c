...
int FUN_ram_4206c058(int param_1,uint param_2,uint param_3,uint param_4,uint param_5,uint *param_6)
  ...
  if (param_3 != 0) {
    ...
    if (uVar7 == 0 && uVar10 == 0) {
      if ((*(uint *)(param_1 + 0x150) & 0xf) != 0) {
        FUN_ram_4206b804(param_1,param_1 + 0x178);
      }
    }
    else {
      uVar3 = uVar7 & 0xf;
      if (uVar3 != 0) {
        ...
        iVar8 = FUN_ram_4206ba14(param_1,&uStack_40,uVar3,uVar5,param_2,param_4);
        if (iVar8 != 0) {
          return iVar8;
        }
        if (uVar3 + uVar5 == 0x10) {
    ...
    *(uint *)(param_1 + 0x14c) = (uVar7 + param_3 < param_3) + uVar10;
    while( true ) {
      ...
      *(char *)(param_1 + 0x177) = (char)((uint)uVar2 >> 0x18);
      iVar4 = FUN_ram_4206ba14(param_1,&uStack_40,0,0x10,iVar4,iVar6);
      if (iVar4 != 0) {
        return iVar4;
      }
      FUN_ram_4206b804(param_1,param_1 + 0x178,param_1 + 0x178);
    ...
    if (param_3 != 0) {
      ...
      *(char *)(param_1 + 0x176) = (char)((uint)uVar2 >> 0x10);
      *(char *)(param_1 + 0x177) = (char)((uint)uVar2 >> 0x18);
      iVar8 = FUN_ram_4206ba14(param_1,&uStack_40,0,param_3,iVar4,iVar6);
      if (iVar8 != 0) {
        return iVar8;
      }
    }
    FUN_ram_4206d7da(&uStack_40);
  }
  return 0;
}
