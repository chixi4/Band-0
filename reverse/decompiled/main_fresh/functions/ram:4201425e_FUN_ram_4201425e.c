...
undefined4
FUN_ram_4201425e(undefined4 *param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)

{
  ...
  if ((puVar1 == (uint *)0x0) || (iVar2 == -1)) {
    ...
    if (UNRECOVERED_JUMPTABLE_00 != (code *)0x0) {
      if ((*puVar1 & 2) != 0) {
                    /* WARNING: Could not recover jumptable at 0x420142be. Too many branches */
