...
undefined4 FUN_ram_4039f0c8(int param_1,uint *param_2)

{
  ...
  if ((bVar1 & 0xc) == 8) {
    ...
    if ((iVar5 != 0) && (*(short *)(param_1 + 0xc) == 1)) {
      ...
      FUN_ram_4039ed16((((param_2[0xb] & 0xffffff) >> 0xc) << 3) / uVar3);
      FUN_ram_4039ebf2(*(undefined4 *)(*(int *)(param_1 + 0x24) + 4),pbVar4 + 0x18,
                       pbVar4 + 0x18 + uVar6,0);
    }
  }
  if (cVar2 != '\x02') {
