...

{
  ...
  if (param_1 != (int *)0x0) goto LAB_ram_42056604;
LAB_ram_420565fc:
...
LAB_ram_42056604:
  ...
  *(char *)((int)psVar5 + 0xf) = (char)((ushort)uVar10 >> 8);
  ...
  if ((DAT_ram_3fcc5309 & 4) == 0) {
    ...
    if (((DAT_ram_3fcc5309 & 2) == 0) || (puVar18[5] - 2 < 2)) {
      if ((uVar17 & 0x10) == 0) {
...
LAB_ram_42056d88:
        if (uVar14 == 3) {
          if (bVar4 == 0) {
            if ((bVar9 & 0x10) != 0) {
              if ((-1 < (int)((_DAT_ram_3fcc5310 - 1) - puVar18[0x12])) &&
                 (-1 < (int)(puVar18[0x15] - _DAT_ram_3fcc5310))) {
                puVar18[5] = 4;
                if (puVar18[0x20] == 0) goto LAB_ram_42056f44;
                if (*(int *)(puVar18[0x20] + 0x1c) != 0) {
                  FUN_ram_4205455a(puVar18);
                  if (*(code **)(puVar18[0x20] + 0x1c) == (code *)0x0) goto LAB_ram_42056f44;
                  ...
                  if (iVar11 != -0xd) goto LAB_ram_42056f44;
                  goto LAB_ram_420569fa;
                }
                goto LAB_ram_420565fc;
              }
          ...
          else if (puVar18[10] - 1 == _DAT_ram_3fcc5314) {
...
LAB_ram_42056cda:
    ...
    if (uVar12 == _DAT_ram_3fcc5314) {
      if (puVar18[5] != 0) goto LAB_ram_42056cda;
      goto LAB_ram_420565fc;
    }
...
LAB_ram_42056cf0:
  ...
  if (_DAT_ram_3fcc5304 == 0) goto LAB_ram_420571c4;
  if (puVar18[0x1f] != 0) goto LAB_ram_420565fc;
...
LAB_ram_42056802:
  if (puVar13 == (uint *)0x0) {
    ...
    puVar21 = (uint *)0x0;
    puVar13 = (uint *)0x0;
    puVar18 = _DAT_ram_3fcc52f4;
    goto LAB_ram_42056818;
  }
  ...
  if ((((char)puVar13[2] == '\0') ||
     ...
     (((short)puVar13[7] == *_DAT_ram_3fcc5324 &&
      (((*(short *)((int)puVar13 + 0x1a) == _DAT_ram_3fcc5324[1] &&
        (_DAT_ram_3fcc26b8 == puVar13[1])) && (*puVar13 == _DAT_ram_3fcc26bc)))))) {
...
LAB_ram_42056818:
  if (puVar18 == (uint *)0x0) goto code_r0x4205681c;
  if ((((char)puVar18[2] == '\0') ||
      ((char)puVar18[2] == (char)(*(char *)(_DAT_ram_3fcc26ac + 0x3c) + '\x01'))) &&
     (*(short *)((int)puVar18 + 0x1a) == _DAT_ram_3fcc5324[1])) {
