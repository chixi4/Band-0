...
uint FUN_ram_403956dc(uint param_1,uint param_2)
...
LAB_ram_40395834:
  ...
  if (param_1 == 2) {
    ...
    FUN_ram_40394cda(uVar1 >> 6 & 1 ^ 1,uVar1 >> 7 & 1 ^ 1);
  }
  return uVar2;
}
