...
undefined4 FUN_ram_4209915a(uint param_1,int param_2,int param_3,int param_4,int param_5)

{
  ...
  piVar2 = (int *)FUN_ram_4039c08e(1,0x30);
  if (piVar2 != (int *)0x0) {
    iVar3 = FUN_ram_4206031c(piVar2 + 2);
    if (-1 < iVar3) {
      uVar5 = piVar2[2];
      uVar11 = piVar2[3];
      uVar7 = param_1 + uVar5;
      ...
      if ((uVar11 <= uVar4) && ((uVar11 != uVar4 || (uVar5 <= uVar7)))) {
        ...
        piVar2[4] = param_2;
        uVar1 = _DAT_ram_3fcc53d4;
        if ((uVar11 <= uVar4) && ((uVar11 != uVar4 || (uVar5 <= uVar7)))) {
          pcVar8 = *(code **)(_DAT_ram_3fcc53c4 + 0x54);
          piVar2[6] = param_4;
          piVar2[7] = param_5;
          piVar2[8] = param_3;
          (*pcVar8)(uVar1);
          for (puVar10 = _DAT_ram_3fcc4890; puVar10 != (undefined4 *)&DAT_ram_3fcc4890;
