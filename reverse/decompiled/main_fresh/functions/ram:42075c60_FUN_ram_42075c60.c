...
undefined4 FUN_ram_42075c60(int *param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  iVar3 = FUN_ram_42076bca(param_2,0);
  if (iVar3 == 0) {
    if ((param_1 == (int *)0x0) || (*param_1 == 0)) {
      FUN_ram_4207a038(1,0x800,1,&DAT_ram_3c0fe4c0,&DAT_ram_3c0c4114,0x12df);
      do {
                    /* WARNING: Do nothing block with infinite loop */
      } while( true );
    }
    (*(code *)&SUB_ram_40011fd0)(_DAT_ram_3fcc4014 != *param_1,auStack_28);
    ...
    if (iVar3 != 0) {
      ...
      *(uint *)(*(int *)(iVar3 + 0x24) + 0x14) = *(uint *)(*(int *)(iVar3 + 0x24) + 0x14) | 4;
      FUN_ram_42076c64(param_2,0);
      iVar5 = (*(code *)&SUB_ram_40011f94)();
      if (iVar5 == 0) {
        *(undefined4 *)(iVar3 + 0x20) = 0;
        uVar4 = 0;
        *_DAT_ram_3fcc416c = iVar3;
        _DAT_ram_3fcc416c = (int *)(iVar3 + 0x20);
      }
      else {
    ...
    FUN_ram_4207a038(1,8,4,&DAT_ram_3c0fbb44);
    uVar4 = 1;
  }
  return uVar4;
}
