...
int FUN_ram_4206b59a(int *param_1,int param_2,uint param_3)

{
  ...
  if (((*param_1 != 0) && (param_2 != 0)) && (pbVar1 = (byte *)param_1[0x10], pbVar1 != (byte *)0x0)
    ...
    if ((iVar3 != 0) && (uVar2 - iVar3 < param_3)) {
      FUN_ram_4039c11e(pbVar1 + iVar3 + 0x10);
      for (pbVar4 = pbVar1; pbVar4 != pbVar1 + uVar2; pbVar4 = pbVar4 + 1) {
        *pbVar4 = pbVar4[0x10] ^ *pbVar4;
      }
      iVar3 = FUN_ram_4206ab3c(param_1,pbVar1,uVar2,pbVar1,auStack_24);
      if (iVar3 != 0) {
        return iVar3;
      }
      iVar3 = *(int *)(pbVar1 + 0x20);
    ...
    if (param_3 != 0) {
      FUN_ram_4039c11e(pbVar1 + *(int *)(pbVar1 + 0x20) + 0x10,param_2,param_3);
