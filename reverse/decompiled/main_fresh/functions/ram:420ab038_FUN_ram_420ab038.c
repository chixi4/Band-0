...
int FUN_ram_420ab038(int *param_1,int param_2,uint *param_3)

{
  ...
  *param_1 = (int)(pcVar8 + 1);
  iVar1 = FUN_ram_4206e8f6(param_1,param_2,aiStack_34);
  if (iVar1 == 0) {
    if (((uint)(iVar10 != 2) * 2 + 0xc == aiStack_34[0]) ||
      ...
      *param_3 = uVar2;
      if (uVar2 != 0xffffffff) {
        ...
        uVar2 = iVar10 + uVar2;
        *param_3 = uVar2;
        uVar3 = FUN_ram_420aabea(iVar1 + 2);
        param_3[1] = uVar3;
        uVar4 = FUN_ram_420aabea(iVar1 + 4);
        param_3[2] = uVar4;
        uVar5 = FUN_ram_420aabea(iVar1 + 6);
        param_3[3] = uVar5;
        uVar6 = FUN_ram_420aabea(iVar1 + 8);
        param_3[4] = uVar6;
        uVar7 = FUN_ram_420aabea(iVar1 + 10);
        param_3[5] = uVar7;
        if (uVar3 - 1 < 0xc) {
