...
int FUN_ram_403a018e(undefined4 *param_1,int param_2,uint param_3,uint param_4)

{
  ...
  iVar1 = (*(code *)_DAT_ram_3fcb82b0[2])(apuStack_44);
  if (iVar1 == 0) {
    if (*(int *)(apuStack_44[0][1] + 0x40) == 0) {
      ...
      while (iVar1 = (*(code *)*_DAT_ram_3fcb82b0)(apuStack_44[0]), iVar1 == 0) {
        iVar1 = param_2;
        if (iVar2 != 0) {
          iVar1 = iVar2;
        }
        ...
        if (iVar1 != 0) {
          (*(code *)_DAT_ram_3fcb82b0[1])(apuStack_44[0],iVar1);
          break;
        }
        iVar1 = (*(code *)_DAT_ram_3fcb82b0[1])(apuStack_44[0],0);
        if (iVar2 != 0) {
          FUN_ram_4039c11e(param_2,iVar2,uVar3);
        }
