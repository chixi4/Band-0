...

{
  ...
  if (DAT_ram_3fcc516c == '\0') {
    ...
    if ((iVar1 != 0x110d) && (iVar1 != 0x1110)) goto LAB_ram_4202188e;
    iVar1 = FUN_ram_4204c3c4();
    if (iVar1 == 0) goto LAB_ram_4202188a;
    do {
      do {
        FUN_ram_4039bf1e();
LAB_ram_4202188a:
        iVar1 = FUN_ram_4204be36();
LAB_ram_4202188e:
      } while ((iVar1 != 0) || (iVar1 = FUN_ram_4205f4fe(), iVar1 != 0));
      ...
      iVar1 = FUN_ram_42060fe0(&iStack_a8);
             ...
             (iVar1 = FUN_ram_420b2e4e(0x8000c000,0xffffffff,0x420114f0,0), iVar1 != 0)) ||
            (iVar1 = FUN_ram_420b2e4e(0x18ff1f,0,0x420114a0,0), iVar1 != 0));
    DAT_ram_3fcc516c = '\x01';
    FUN_ram_42021346(1);
  }
  return 0;
}
