...
void FUN_ram_420ae4a8(int param_1,int param_2,undefined4 param_3,ushort *param_4,int *param_5)

{
  ...
  uVar11 = *param_4;
  uVar3 = param_4[1];
  uVar6 = (**(code **)(_DAT_ram_3fcc4c78 + 0x74))(1,2);
  uVar9 = 0;
  uVar12 = 0;
  do {
    uVar1 = uVar9 & 0x1f;
  ...
  do {
    ...
    pcVar13 = *(code **)(_DAT_ram_3fcc4c78 + 0x70);
    *param_4 = uVar11;
    param_4[1] = uVar3;
    (*pcVar13)(2,cVar15,uVar11);
    (**(code **)(_DAT_ram_3fcc4c78 + 0x70))(3,cVar15,param_4[1]);
    if (param_2 == 0) {
      (*(code *)&SUB_ram_40010044)(10);
      FUN_ram_420ae3ee(param_3,1,param_5);
      sVar2 = 3 < uVar12;
    }
    else {
      (**(code **)(_DAT_ram_3fcc4c78 + 0x70))(1,2,0);
      (*(code *)&SUB_ram_40010044)(10);
      FUN_ram_420ae3ee(param_3,1,&iStack_58);
      (**(code **)(_DAT_ram_3fcc4c78 + 0x70))(1,2,0x20);
      (*(code *)&SUB_ram_40010044)(10);
      FUN_ram_420ae3ee(param_3,1,&iStack_4c);
...
LAB_ram_420ae5c2:
      ...
      if (iVar7 == 0) goto LAB_ram_420ae5de;
    }
    if (param_2 != 0) {
      if (0x2c < iVar18) {
        iVar7 = 0;
  ...
  (**(code **)(_DAT_ram_3fcc4c78 + 0x70))(2,cVar15,*param_4);
  (**(code **)(_DAT_ram_3fcc4c78 + 0x70))(3,cVar15,param_4[1]);
  return;
}
