...
undefined4
FUN_ram_4209d59a(int param_1,undefined4 param_2,int param_3,undefined4 param_4,undefined4 param_5,
...

{
  ...
  if (param_6 != 0) {
    iVar1 = FUN_ram_4209c13c(*(undefined4 *)(param_1 + 0x1f0),*(undefined4 *)(param_1 + 0x40));
    iVar3 = 0x5f;
    if (iVar1 == 0x18) {
      iVar3 = 0x67;
    }
    iVar3 = thunk_FUN_ram_4209f54c
    ...
    if (iVar3 != 0) {
      ...
      *apuStack_44[0] = uVar4;
      ...
      FUN_ram_4039c11e(apuStack_44[0] + 5,param_3 + 5,8);
      ...
      FUN_ram_4039c11e(puVar2,param_6,param_7);
      FUN_ram_4039c11e(apuStack_44[0] + 0xd,param_5,0x20);
      FUN_ram_4209d38c(param_1,param_8,*(undefined4 *)(param_8 + 0x58),param_4,param_2,0x888e,iVar3,
                       uStack_48,apuStack_44[0] + 0x4d);
      thunk_FUN_ram_4209f5ca(iVar3);
      return 0;
    }
  }
  return 0xffffffff;
