...
undefined4
FUN_ram_4208a4da(int *param_1,int param_2,uint param_3,undefined4 param_4,undefined4 param_5)

{
  ...
  if ((param_1 == (int *)0x0) || (iVar6 = *param_1, iVar6 == 0)) {
    FUN_ram_4207a038(1,0x800,1,&DAT_ram_3c0ff0ac,"small reward after work.",0xb17);
    do {
      ...
      if ((int)(param_3 - (int)pbVar19) < 2) {
        ...
        *(undefined2 *)((int)param_1 + 0x26) = uVar2;
        ...
        if ((((*(uint *)(iVar6 + 0xa4) & 0x2000) == 0) || (pbVar21 == (byte *)0x0)) ||
           (iVar8 = FUN_ram_42088f64(param_1,pbVar21), iVar8 < 0)) {
        ...
        if (((pbVar11 != (byte *)0x0) && (pbVar12 != (byte *)0x0)) &&
          ...
          FUN_ram_4207cf3a(param_1,pbVar11,pbVar12);
          FUN_ram_4207d0b6(param_1,pbVar11,0x30);
          FUN_ram_4207d1b6(param_1,pbVar12);
        }
        if ((local_70 != (byte *)0x0) && (iVar6 = FUN_ram_420893ba(), iVar6 != 0)) {
          FUN_ram_4208920a(param_1,local_70);
        }
        if ((_DAT_ram_3fcc41fc & 1) != 0) {
          param_1[0xba] = 0;
          if ((pbVar22 != (byte *)0x0) && ((pbVar22[2] & 1) != 0)) {
            param_1[0xba] = 1;
            FUN_ram_4207a038(1,4,4,&DAT_ram_3c0fd974);
          }
          FUN_ram_420891f6(param_1,pbStack_68);
        }
        FUN_ram_4208b66e(&DAT_ram_3fcc4004,*(ushort *)((int)param_1 + 0x2a) & 0x400);
        if (((byte)(*(char *)((int)param_1 + 0x32) - 2U) < 2) &&
           ((*(ushort *)(param_1 + 0xb) & 2) != 0)) {
          _DAT_ram_3fcc4020 = _DAT_ram_3fcc4020 | 0x100000;
        }
        else {
          _DAT_ram_3fcc4020 = _DAT_ram_3fcc4020 & 0xffefffff;
        }
        iVar8 = param_1[6];
        iVar7 = param_1[7];
        iVar6 = param_1[8];
        *(int **)(_DAT_ram_3fcc4004 + 0xf00) = param_1;
        ...
        if (DAT_ram_3fcc41bd == '\x0f') {
          ...
          iVar6 = (**(code **)(_DAT_ram_3fcc4178 + 0x60))
                            (pbVar14,bVar9,pbStack_64,uStack_60,0xf,
                             *(code **)(_DAT_ram_3fcc4178 + 0x60));
          if (iVar6 != 0) {
            FUN_ram_4207a038(1,4,1,&DAT_ram_3c0ff1bc);
            return 0xffffffff;
          }
        }
        FUN_ram_4207a038(1,0xc,4,&DAT_ram_3c0fd9a4,6);
        FUN_ram_4207f554(6);
        FUN_ram_42089514(&DAT_ram_3fcc4004,5,param_4);
...
LAB_ram_4208a76c:
          ...
          if ((uVar10 < 4) || (pbVar20 = pbVar19, *(int *)(pbVar19 + 2) != 0x2f25000)) {
            if ((_DAT_ram_3fcc4268 == 0) || ((uVar10 < 4 || (*(int *)(pbVar19 + 2) != 0x734fe18))))
            {
              if ((*(uint *)(iVar6 + 300) & 0x10000000) == 0) {
                ...
                if (3 < uVar10) {
                  if (*(uint *)(pbVar19 + 2) == 0xdd34fe18) {
                    ...
                    (*_DAT_ram_3fcc40c8)(_DAT_ram_3fcc40cc,4,param_2 + 10,pbVar19,param_5);
                  }
                }
              }
              else {
                ...
                if ((3 < uVar10) &&
                   (((pbVar18 = pbVar11, *(int *)(pbVar19 + 2) == 0x334c9000 ||
                    ...
                    (pbVar18 == (byte *)0x0)))) goto LAB_ram_4208a76c;
              }
            }
            else {
          ...
          if (uVar10 == 0) {
            FUN_ram_4207a038(1,4,2,&DAT_ram_3c102040);
          }
  ...
  if (uVar10 == 0x1e) {
    iVar8 = thunk_FUN_ram_4208c19c(0x38,pbVar19,param_3 - (int)pbVar19);
      ...
      if (uVar3 < 0x1389) {
        ...
        *(char *)(param_1 + 0xed) = (char)iVar7 + '\x01';
        if ((byte)((char)iVar7 + 1U) < 2) {
          FUN_ram_4207a038(1,4,3,&DAT_ram_3c1001dc,uVar3,uVar3 + 100);
          iVar7 = iVar6 + 0x54;
          ...
          (**(code **)(_DAT_ram_3fcdfdd8 + 0xec))(iVar7,0x42078dc6,0);
          (**(code **)(_DAT_ram_3fcdfdd8 + 0xf0))(iVar7,(*(int *)(iVar8 + 3) + 100) * 0x400,0);
          return 0;
        }
        FUN_ram_4207a038(1,4,1,&DAT_ram_3c0ff110);
      }
      else {
        FUN_ram_4207a038(1,4,1,&DAT_ram_3c0ff0b4);
      }
      FUN_ram_42089514(&DAT_ram_3fcc4004,0,0xd010);
      return 0;
    }
  }
  else if (uVar10 == 0x12) {
    FUN_ram_4207a038(1,4,1,&DAT_ram_3c0ff144,0x12);
    goto LAB_ram_4208a6a0;
  }
  FUN_ram_4207a038(1,4,1,&DAT_ram_3c0ff1a8);
LAB_ram_4208a6a0:
  FUN_ram_42089514(&DAT_ram_3fcc4004,0,uVar10 << 8 | 0x10);
  iVar8 = FUN_ram_4207fec0();
  if (iVar8 != 0) {
    iVar6 = iVar6 + 4;
    (**(code **)(_DAT_ram_3fcdfdd8 + 0xe4))(iVar6);
    (**(code **)(_DAT_ram_3fcdfdd8 + 0xe8))(iVar6);
    (**(code **)(_DAT_ram_3fcdfdd8 + 0xec))(iVar6,0x42075280,0);
