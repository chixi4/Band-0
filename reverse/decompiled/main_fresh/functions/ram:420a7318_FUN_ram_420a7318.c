...
int FUN_ram_420a7318(int *param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)

{
  ...
  *(int *)(pcVar8 + 4) = iVar9;
  iVar11 = (**(code **)(iVar11 + 0x1c))
                     (*(undefined4 *)(iVar11 + 0x20),pcVar8 + 0x18c,0x20,param_4,
                      *(code **)(iVar11 + 0x1c));
  if (iVar11 != 0) {
    return iVar11;
  }
  if (param_1[2] == 0x303) {
    if (*(int *)(iVar4 + 0xc) - 0x10U < 0x11) {
      if (*(char *)param_1[0xe] != '\0') goto LAB_ram_420a737a;
    }
    else if (*(int *)(iVar4 + 0xc) == 0) goto LAB_ram_420a737a;
    *(undefined4 *)(iVar4 + 0xc) = 0;
  }
LAB_ram_420a737a:
  iVar11 = FUN_ram_420a4788(param_1,1,&puStack_3c,&iStack_38);
  iVar4 = iStack_38;
  puVar3 = puStack_3c;
  if (iVar11 != 0) {
    return iVar11;
  ...
  if ((puStack_3c <= puVar14) && (1 < iStack_38)) {
    FUN_ram_420a518e(puStack_3c,*(undefined1 *)(*param_1 + 9),0x303);
    if ((puVar3 + 2 <= puVar14) &&
       (((0x1f < iVar4 - 2U &&
         (FUN_ram_4039c11e(puVar3 + 2,iVar11 + 0x18c,0x20), puVar3 + 0x22 <= puVar14)) &&
        (*(int *)(param_1[0xd] + 0xc) + 1U <= iVar4 - 0x22U)))) {
      puVar3[0x22] = (char)*(int *)(param_1[0xd] + 0xc);
      FUN_ram_4039c11e(puVar3 + 0x23,param_1[0xd] + 0x10,*(undefined4 *)(param_1[0xd] + 0xc));
      uStack_34 = 0;
      ...
      if ((puVar5 <= puVar14) && (1 < (int)puVar14 - (int)puVar5)) {
        ...
        for (piVar19 = *(int **)(*param_1 + 0x10); iVar4 = *piVar19, iVar4 != 0;
            piVar19 = piVar19 + 1) {
          uVar7 = FUN_ram_420a3df0(iVar4);
          iVar11 = FUN_ram_420a62e6(param_1,uVar7,*(undefined4 *)(param_1[0xe] + 4),param_1[2]);
          if (iVar11 == 0) {
            uVar17 = FUN_ram_420a3e7c(uVar7);
            if (puVar14 < puVar13) {
              return -0x6a00;
            }
        ...
        if ((puVar13 <= puVar14) && (1 < (int)puVar14 - (int)puVar13)) {
          ...
          *puVar5 = (char)((uint)((int)puVar13 - (int)puVar5) >> 8);
          ...
          if ((puVar10 <= puVar14) && (1 < (int)puVar14 - (int)puVar10)) {
            ...
            puVar13[3] = 0;
            if ((puVar5 <= puVar14) && (1 < (int)puVar14 - (int)puVar5)) {
              iVar4 = FUN_ram_420a5704(param_1);
              uStack_34 = 0;
              puVar10 = puVar13 + 6;
              if (iVar4 == 0) {
                uVar17 = 0;
                ...
                FUN_ram_4039c11e(puVar13 + 0xf,iVar4,uVar6);
              }
              ...
              if (piVar19 != (int *)0x0) {
                ...
                *puVar10 = 0;
                ...
                for (; *piVar19 != 0; piVar19 = piVar19 + 1) {
                  ...
                  *puVar21 = (char)iVar4;
                  iVar11 = FUN_ram_4039c11e(puVar21 + 1,*piVar19,iVar4);
              ...
              if (bVar2) {
                ...
                if (uVar15 != 0) {
                  ...
                  for (; *psVar16 != 0; psVar16 = psVar16 + 1) {
                    ...
                    if (((ushort)(*psVar16 - 0x12U) < 0xd) &&
                       (iVar4 = FUN_ram_420a5b9a(), iVar4 != 0)) {
                      if (puVar14 < puVar10) {
                        return -0x6a00;
                      }
                ...
                iVar4 = FUN_ram_420a6300(param_1,puVar10,puVar14,&uStack_34);
                if (iVar4 != 0) {
                  return iVar4;
                }
                puVar10 = puVar10 + uStack_34;
                iVar4 = FUN_ram_420a7818(param_1,puVar10,puVar14,uVar15,&uStack_34);
                if (iVar4 != 0) {
                  return iVar4;
                }
              ...
              iVar4 = FUN_ram_420a55d2(param_1,1,iVar11);
              if (iVar4 != 0) {
                return iVar4;
              }
              ...
              iVar4 = FUN_ram_420a4a6a(param_1,iStack_38,iVar11);
              if (iVar4 == 0) {
                param_1[1] = 2;
                return 0;
              }
