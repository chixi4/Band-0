...
void FUN_ram_420795fc(undefined4 param_1)

{
  ...
  DAT_ram_3fcc4261 = (undefined1)iVar6;
  *(undefined1 *)((int)_DAT_ram_3fcdfb1c + 0x4f) = 0xe;
  ...
  do {
    ...
    *(short *)(pcVar3 + 2) = (short)iVar5 * 5 + 0x96c;
    ...
    if (*pcVar3 == '\0') {
      cVar4 = FUN_ram_42079142(*(undefined2 *)(pcVar3 + 2),0x83);
      *pcVar3 = cVar4;
    }
    iVar5 = iVar5 + 1;
    pcVar3 = pcVar3 + 0xc;
  ...
  if (*pcVar2 == '\x02') {
    ...
    uStack_44._0_1_ = '\x01';
    if (iVar6 == 1) {
      uStack_44._0_1_ = FUN_ram_4208b96c(1);
    }
  }
  puVar1 = _DAT_ram_3fcdfb1c;
  *(undefined1 *)(_DAT_ram_3fcdfb1c + 1) = 0xff;
  *puVar1 = param_1;
  FUN_ram_42079418(&uStack_44);
  FUN_ram_42079510(&uStack_44);
  (**(code **)(_DAT_ram_3fcdfdd8 + 0xec))(_DAT_ram_3fcdfb1c + 9,0x42069138,0);
  (**(code **)(_DAT_ram_3fcdfdd8 + 0xec))(_DAT_ram_3fcdfb1c + 0xe,0x42069138,1);
  return;
}
