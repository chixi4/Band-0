...

{
  ...
  local_a0[0] = 0x481ff;
  local_a0[1] = (uint)DAT_ram_3fcb7efc << 9 | 0x801ff;
  local_a0[2] = 0x1713ff;
  local_a0[3] = 0x4801ff;
  local_a0[4] = 0xf50000;
  local_a0[5] = 0xf60000;
  FUN_ram_4039c11e(auStack_e0,0x3fcb866c,0x10);
  FUN_ram_4039c11e(local_58,0x3fcb867c,0x1c);
  FUN_ram_4039c11e(auStack_d0,0x3fcb8698,0x10);
  FUN_ram_4039c11e(auStack_f8,0x3fcb86a8,0xc);
  iVar6 = 0;
  do {
  ...
  local_a0[8] = 0x1717ff;
  uStack_ec = 0x14fdff;
  local_3c[2] = (uint)DAT_ram_3fcb7f0e << 0xc | 0x4801ff;
  uStack_ac = 0x4807ff;
  local_a0[9] = 0x4807ff;
  iVar6 = 0;
  do {
  ...
  while( true ) {
    *puVar5 = *puVar5 & 0xffff0000 | ((uVar1 + 5) * 0x100 | uVar1) & 0xffff;
    ...
    if (uVar7 < 0xb) {
                    /* WARNING: Could not emulate address calculation at 0x420ad2da */
                    /* WARNING: Treating indirect jump as call */
      (**(code **)(uVar7 * 4 + 0x3fcb8640))();
      return;
    }
    puVar4 = local_70;
    uVar1 = uVar1 + 6;
