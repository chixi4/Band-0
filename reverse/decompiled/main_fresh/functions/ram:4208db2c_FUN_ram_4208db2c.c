...
undefined4 FUN_ram_4208db2c(int param_1,undefined4 param_2,uint param_3,undefined1 param_4)
      ...
      if (param_3 < 0x20) {
        ...
        if (bVar3 == 0) {
          if (*(byte *)(_DAT_ram_3fcdfb20 + 0x110) < 3) {
            FUN_ram_4207a038(1,8,5,
                             "..." /* TRUNCATED STRING LITERAL */
                            );
            uVar6 = (uint)*(byte *)(_DAT_ram_3fcdfb20 + 0x110);
            *(byte *)(_DAT_ram_3fcdfb20 + 0x110) = *(byte *)(_DAT_ram_3fcdfb20 + 0x110) + 1;
          }
          FUN_ram_4039c11e(_DAT_ram_3fcdfb20 + uVar6 * 0x24 + 0xa4,param_1,param_3);
          ...
          *(undefined1 *)(iVar5 + 199) = param_4;
          FUN_ram_4207a038(1,8,5,
                           "..." /* TRUNCATED STRING LITERAL */
                           ,param_1,param_2);
          uVar2 = 1;
        }
      }
