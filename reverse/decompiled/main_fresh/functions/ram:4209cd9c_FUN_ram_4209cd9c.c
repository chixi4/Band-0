...
int * FUN_ram_4209cd9c(int *param_1,int *param_2)

{
  ...
  while (piVar5 = piVar4, piVar5 != (int *)0x0) {
    iVar1 = FUN_ram_4039c0e0(param_2 + 0x19,piVar5 + 0x19,6);
    if (iVar1 == 0) {
      iVar1 = piVar5[0x15];
      if (((iVar1 == param_2[0x15]) &&
          (iVar2 = FUN_ram_4039c0e0(piVar5 + 5,param_2 + 5,iVar1), iVar2 == 0)) &&
         (iVar2 = FUN_ram_4039c0e0(piVar5 + 1,param_2 + 1,0x10), iVar2 == 0)) {
      ...
      if (piVar5[0x1f] == 0) {
        FUN_ram_4209cd1a(param_1,param_2[0x1e],piVar5 + 5,iVar1);
      }
      FUN_ram_4209cc64(param_1,piVar5,1);
      break;
    }
    piVar3 = piVar5;
    piVar4 = (int *)*piVar5;
  ...
  if ((9 < param_1[1]) && (piVar4 = (int *)*param_1, piVar4 != (int *)0x0)) {
    ...
    if (*(int **)(param_1[2] + 0x1c0) == piVar4) {
      if (piVar3 == (int *)0x0) goto LAB_ram_4209ce6a;
    ...
    FUN_ram_4209cc64(param_1,piVar4,0);
  }
LAB_ram_4209ce6a:
  piVar4 = (int *)0x0;
