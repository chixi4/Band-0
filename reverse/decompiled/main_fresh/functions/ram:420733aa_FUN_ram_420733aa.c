...
int FUN_ram_420733aa(undefined4 *param_1)

{
  ...
  for (uVar5 = 0; (int)uVar5 < (int)param_1[4]; uVar5 = uVar5 + 1) {
    ...
    if (iVar3 != 0) goto LAB_ram_420733da;
    if (iStack_a4 != 0) {
      iVar4 = FUN_ram_4207330a(param_1,uVar5 & 0xff,auStack_a0);
      if (iVar4 != 0) {
        return iVar4;
      }
...
LAB_ram_420733da:
  FUN_ram_4206d7da(auStack_a0,0x80);
  return iVar3;
}
