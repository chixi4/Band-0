...
undefined4 thunk_FUN_ram_420b008c(undefined4 *param_1,int *param_2,uint param_3,uint param_4)
...
LAB_ram_420b021e:
  ...
  if (param_4 == 1) {
    ...
    if ((int)((uint)*(ushort *)(param_2 + 3) << 0x13) < 0) {
      ...
      if (iVar3 == -1) goto LAB_ram_420b01dc;
    }
    ...
    uVar8 = 0x16;
    if ((param_4 & 0xfffffffd) != 0) goto LAB_ram_420b021e;
    bVar1 = false;
    iVar3 = 0;
  }
  if (param_2[4] == 0) {
  ...
  if (((uint)(int)(short)param_2[3] >> 1 & 0x40d) == 0) {
    if (((int)(short)param_2[3] & 0x400U) == 0) {
      if ((((pcVar10 != (code *)0x420a004c) || (*(short *)((int)param_2 + 0xe) < 0)) ||
          (iVar4 = FUN_ram_420141fc(param_1,(int)*(short *)((int)param_2 + 0xe),auStack_88),
          iVar4 != 0)) || ((uStack_84 & 0xf000) != 0x8000)) {
        *(ushort *)(param_2 + 3) = *(ushort *)(param_2 + 3) | 0x800;
        goto LAB_ram_420b017c;
      }
    ...
    if (param_4 != 0) {
      iVar4 = FUN_ram_420141fc(param_1,(int)*(short *)((int)param_2 + 0xe),auStack_88);
      if (iVar4 != 0) goto LAB_ram_420b017c;
    ...
    if (!bVar1) {
      if ((int)((uint)*(ushort *)(param_2 + 3) << 0x13) < 0) {
        ...
        iVar3 = (*pcVar10)(param_1,param_2[8],0,1);
        if (iVar3 == -1) goto LAB_ram_420b017c;
      }
      iVar3 = iVar3 - param_2[1];
      if (param_2[0xd] != 0) {
        iVar3 = iVar3 - param_2[0x10];
    ...
    if (((int)uVar11 < iVar3) || ((uint)(iVar3 + iVar9 + iVar6) <= uVar11)) {
      ...
      if (iVar3 != -1) {
        ...
        *(ushort *)(param_2 + 3) = *(ushort *)(param_2 + 3) & 0xffdf;
        if (uVar11 == uVar2) goto LAB_ram_420b0366;
        iVar3 = FUN_ram_420b1608(param_1,param_2);
        if ((iVar3 == 0) && (uVar12 <= (uint)param_2[1])) {
          param_2[1] = param_2[1] - uVar12;
          *param_2 = *param_2 + uVar12;
          goto LAB_ram_420b0366;
        }
      }
      goto LAB_ram_420b017c;
    }
