...
void FUN_ram_420635ec(int param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4)

{
  if (*(code **)(param_1 + 0x84) != (code *)0x0) {
    ...
    *(undefined4 *)(param_1 + 0xa8) = *(undefined4 *)(param_1 + 0x28);
                    /* WARNING: Could not recover jumptable at 0x42063604. Too many branches */
