...
bool FUN_ram_42018e12(int param_1,int param_2,int param_3,int param_4,int param_5,int param_6,
                     int param_7)
...
LAB_ram_42018eb6:
    ...
    if (param_2 < param_4 + param_7) {
      ...
      goto LAB_ram_42018e78;
    }
    if (param_1 < iVar1) goto LAB_ram_42018eb6;
  }
