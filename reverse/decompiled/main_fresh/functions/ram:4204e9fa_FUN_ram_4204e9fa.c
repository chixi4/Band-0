...
int FUN_ram_4204e9fa(int param_1,undefined4 param_2,undefined4 param_3,int param_4,
                    undefined4 *param_5)

{
  ...
  if ((param_5 != (undefined4 *)0x0) && (iVar1 = 0x1101, *(int *)(param_1 + 0x18) != 0)) {
    iVar2 = FUN_ram_4204e9c8();
    iVar1 = 0x110f;
    if (iVar2 != 0) {
      if ((param_4 == 1) && (iVar1 = (**(code **)(**(int **)(iVar2 + 8) + 0x28))(), iVar1 != 0)) {
        return 0x10d;
      }
      iVar1 = FUN_ram_4204e426(iVar2,param_3,param_4 == 1,auStack_21);
      if (iVar1 == 0) {
        puVar3 = (undefined4 *)thunk_FUN_ram_403904a6(0x14);
        if (puVar3 == (undefined4 *)0x0) {
          iVar1 = 0x101;
        }
        else {
          *puVar3 = &DAT_ram_3c0f73d0;
