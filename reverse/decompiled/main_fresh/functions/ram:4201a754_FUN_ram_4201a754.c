...
bool FUN_ram_4201a754(int param_1,int param_2,int param_3,int param_4,int param_5,int param_6,
                     int param_7)
...
LAB_ram_4201a7f8:
    ...
    if (param_2 < param_4 + param_7) {
      ...
      goto LAB_ram_4201a7ba;
    }
    if (param_1 < iVar1) goto LAB_ram_4201a7f8;
  }
