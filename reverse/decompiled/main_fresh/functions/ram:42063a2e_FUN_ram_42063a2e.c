...
undefined8 FUN_ram_42063a2e(int param_1)
...
LAB_ram_42063a82:
    ...
    *puVar2 = 0;
    iVar1 = FUN_ram_420a3480(*(undefined4 *)(param_1 + 0x1c),*puVar5,*(undefined4 *)(param_1 + 0x8c)
    ...
    if (iVar1 < 1) {
      ...
      iVar3 = -1;
      goto LAB_ram_42063a82;
    }
    FUN_ram_4209fdce(*(undefined4 *)(param_1 + 0x10),*(undefined4 *)(param_1 + 0x14),*puVar5,iVar1);
  } while( true );
}
