...
void FUN_ram_420947b2(int param_1)

{
  ...
  if (((uVar9 == 0) || (*(uint *)(param_1 + 0x3c) < 100)) ||
    ...
    *(int *)(param_1 + 0x60) = iVar5;
    ...
    goto LAB_ram_4209485a;
  }
  uVar9 = (uint)(*(int *)(param_1 + 0x2c) << 7) / uVar9;
  *(undefined4 *)(param_1 + 0x38) = uVar4;
  pcVar10 = *(char **)(param_1 + 0x60);
  uVar6 = _DAT_ram_3fcb7d8c + 1;
  _DAT_ram_3fcb7d8c = uVar6;
  ...
  *(char *)(param_1 + 0x1c) = (char)iVar5;
  ...
  bVar1 = pcVar10[0xb];
  if (((bVar1 & 1) == 0) && ((uVar6 & 3) != 0)) goto LAB_ram_4209485a;
  cVar3 = *pcVar10;
...
LAB_ram_420949f2:
  ...
  else if ((byte)(cVar3 - 0x29U) < 2) goto LAB_ram_420949f2;
  if ((bVar1 & 1) != 0) {
