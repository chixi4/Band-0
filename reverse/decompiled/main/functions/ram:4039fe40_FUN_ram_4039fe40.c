...
int FUN_ram_4039fe40(int param_1,uint param_2,uint param_3)

{
  ...
  uVar16 = (*(code *)_DAT_ram_3fcb82b0[2])(aiStack_44);
  ...
  if (iVar4 == 0) {
    if ((*(int *)(*(int *)(aiStack_44[0] + 4) + 0x18) == 0) ||
      ...
      if (*(int *)(iVar10 + 0x1c) != 0) {
        uVar14 = *(uint *)(iVar10 + 0x24);
      }
      uVar15 = *(uint *)(iVar10 + 0x20);
      if ((uVar15 == 0) || (uVar14 % uVar15 != 0)) {
        iVar4 = 0x6003;
      }
        ...
        if ((*(int *)(iVar10 + 0x38) != 0) && (*(char *)(iVar10 + 0x30) != '\0')) {
          ...
          uVar16 = (*(code *)_DAT_ram_3fcb82b0[1])(iVar4,iVar5);
          uVar7 = (undefined4)((ulonglong)uVar16 >> 0x20);
          if ((int)uVar16 != 0) {
            return (int)uVar16;
          }
        ...
        do {
          ...
          iVar4 = (*(code *)*_DAT_ram_3fcb82b0)(aiStack_44[0],uVar7);
          if (iVar4 != 0) {
            uVar7 = 0;
            goto LAB_ram_4039ff02;
          }
          if (((uVar14 == 0) || (uVar13 < uVar14)) || (uVar11 % uVar14 != 0)) {
          ...
          if ((iVar4 != 0) || (uVar13 == 0)) break;
          iVar4 = (*(code *)_DAT_ram_3fcb82b0[1])(aiStack_44[0]);
          uVar7 = 0;
          uVar11 = uVar11 + uVar6;
        } while (iVar4 == 0);
        uVar7 = 1;
LAB_ram_4039ff02:
        iVar4 = (*(code *)_DAT_ram_3fcb82b0[3])
                          (aiStack_44[0],iVar4,uVar7,param_2,param_3,(code *)_DAT_ram_3fcb82b0[3]);
      }
    }
  }
  return iVar4;
