...
void FUN_ram_420af180(undefined4 param_1,int param_2,int param_3,int param_4,int param_5,
...

{
  ...
  do {
    ...
    do {
      ...
      iVar1 = (**(code **)(_DAT_ram_3fcc4c78 + 0xc0))(param_6);
      iVar3 = (**(code **)(_DAT_ram_3fcc4c78 + 0xc0))(param_6);
      ...
      if ((int)uVar11 < 0x19) {
        if ((int)uVar11 < -0x18) {
          uVar11 = 0xffffffe8;
          goto LAB_ram_420af35a;
        }
        if (param_8 != 0) goto LAB_ram_420af2ac;
LAB_ram_420af2c4:
        if (uVar11 == 0) {
          if (iVar10 != 0) break;
        }
...
LAB_ram_420af35a:
        if (param_8 != 0) {
LAB_ram_420af2ac:
          FUN_ram_420af7f6(0x3fcb85c4,iVar10,iVar1,uVar2,uVar11,iVar7,uVar5);
          goto LAB_ram_420af2c4;
        }
      }
      if (uVar8 == 0) break;
      if (iVar6 < 1) {
