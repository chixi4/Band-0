...

{
  ...
  if (3 < *(uint *)(param_1 + 0x14)) goto LAB_ram_42055ad0;
LAB_ram_42055ac8:
...
LAB_ram_42055bc0:
  ...
  if ((_DAT_ram_3fcc530a == 0) || (6 < *(uint *)(param_1 + 0x14))) {
    if ((_DAT_ram_3fcc5314 - iVar14 < 0) ||
       ((int)((iVar14 - _DAT_ram_3fcc5314) + -1 + (uint)*(ushort *)(param_1 + 0x2c)) < 0)) {
...
LAB_ram_420562e8:
  ...
  if (((int)(uVar11 - 1) < 0) ||
    ...
    for (piVar8 = (int *)_DAT_ram_3fcc2534; uVar17 = *(ushort *)((int)piVar8 + 10), uVar17 < uVar12;
        piVar8 = (int *)*piVar8) {
...
LAB_ram_420562b2:
          ...
          goto LAB_ram_420562be;
        }
        iVar14 = *(int *)(puVar3[3] + 4);
        if (iVar14 != *(int *)(param_1 + 0x28)) goto LAB_ram_420562b2;
        ...
        *(uint *)(param_1 + 0x28) =
        ...
        if ((uint)uVar2 < (uint)((uVar11 & 3) != 0) + (uint)uVar17) break;
...
LAB_ram_4205638c:
      ...
      if (piVar22 == (int *)0x0) {
        ...
        iVar14 = FUN_ram_420548e2(&DAT_ram_3fcc2530);
        if (iVar14 != 0) {
          if ((int)(_DAT_ram_3fcc5314 - ((uint)*(ushort *)(piVar22 + 2) + *(int *)(piVar22[3] + 4)))
              < 0) {
            *(short *)(piVar22 + 2) =
                 (short)((uint)((_DAT_ram_3fcc5314 - *(int *)(piVar22[3] + 4)) * 0x10000) >> 0x10);
    ...
    if ((-1 < iVar14 - _DAT_ram_3fcc5314) ||
       (uVar11 = FUN_ram_420523aa(*(undefined2 *)(piVar5[3] + 0xc)), (uVar11 & 1) != 0))
    goto LAB_ram_4205631c;
    iVar14 = FUN_ram_420548e2(&DAT_ram_3fcc2530);
    *piVar5 = iVar14;
    if (iVar14 == 0) goto LAB_ram_4205631c;
    if ((int)(_DAT_ram_3fcc5314 - ((uint)*(ushort *)(piVar5 + 2) + *(int *)(piVar5[3] + 4))) < 0) {
      *(short *)(piVar5 + 2) =
           (short)((uint)((_DAT_ram_3fcc5314 - *(int *)(piVar5[3] + 4)) * 0x10000) >> 0x10);
      FUN_ram_42053cac(piVar5[1]);
    }
    if (-1 < (int)((*(int *)(param_1 + 0x28) - ((uint)_DAT_ram_3fcc530a + _DAT_ram_3fcc5314)) +
                  (uint)*(ushort *)(param_1 + 0x2c))) goto LAB_ram_4205631c;
    ...
    *(short *)(iVar14 + 8) =
    ...
    if ((uint)_DAT_ram_3fcc530a + _DAT_ram_3fcc5314 ==
        (uint)*(ushort *)(param_1 + 0x2c) + *(int *)(param_1 + 0x28)) goto LAB_ram_4205631c;
    goto LAB_ram_42055ac8;
  }
