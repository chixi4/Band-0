...
void FUN_ram_4207b49e(int *param_1,uint param_2)

{
  ...
  if (iVar1 != 0) {
    iVar3 = *param_1;
    uVar2 = 0;
    if (iVar3 != _DAT_ram_3fcc4014) {
      if ((iVar3 == _DAT_ram_3fcc4018) || (iVar3 == _DAT_ram_3fcc4254)) {
    ...
    FUN_ram_420927d6(iVar3 != _DAT_ram_3fcc4014,uVar2,*(undefined1 *)(iVar1 + 0x2f),0,param_1 + 1);
    FUN_ram_4207b474(iVar1);
