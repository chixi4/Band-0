...
uint FUN_ram_420607f0(int param_1,uint param_2,char *param_3)
...
LAB_ram_420608e6:
    ...
    if (bVar1 != 0x65) goto LAB_ram_4206081c;
    uVar7 = 0x1b;
  }
  else {
    if (bVar1 != 0x74) {
      if (bVar1 == 0x78) {
        iVar5 = FUN_ram_420606e0(pcVar4 + 2);
        if (iVar5 == -1) {
          iVar5 = FUN_ram_420606a8(pcVar4[2]);
          param_3 = pcVar4 + 2;
          if (iVar5 != -1) {
