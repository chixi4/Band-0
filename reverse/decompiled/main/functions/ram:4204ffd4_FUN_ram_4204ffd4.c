...

{
  ...
  if ((param_3[2] == 0) && (0 < param_3[3])) {
    ...
    iVar3 = 0;
    uVar1 = *(ushort *)(*piVar5 + 8);
    for (uVar2 = 0; (iVar3 < param_3[3] && (uVar2 < uVar1)); uVar2 = uVar2 + uVar7 & 0xffff) {
      puVar6 = (undefined4 *)(param_3[2] + iVar3 * 8);
      uVar4 = puVar6[1];
      uVar7 = uVar1 - uVar2 & 0xffff;
      if (uVar4 <= uVar7) {
        uVar7 = uVar4 & 0xffff;
      }
      FUN_ram_42053f22(*apiStack_34[0],*puVar6,uVar7,uVar2);
      iVar3 = iVar3 + 1;
    }
