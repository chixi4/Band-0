...
undefined4
FUN_ram_420ab892(undefined4 param_1,int param_2,uint *param_3,undefined2 param_4,int *param_5,
                int param_6)
    ...
    *(undefined4 *)(iVar3 + 4) = 2;
    ...
    if ((((param_6 == 0) && (param_2 != 0)) && (param_3 != (uint *)0x0)) && ((*param_3 & 2) != 0)) {
      *(int *)(iVar3 + 0x18) = iVar3 + 0x30;
      iVar5 = FUN_ram_4039c11e(iVar3 + 0x30,param_2,uVar2);
