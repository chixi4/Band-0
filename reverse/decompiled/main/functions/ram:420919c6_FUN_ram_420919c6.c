...
void FUN_ram_420919c6(uint param_1)

{
  ...
  if ((param_1 & 0xffffffbf) == 0) {
    ...
    if (param_1 == 2) {
      uVar3 = 100;
      if (DAT_ram_3fcc45c9 == '\0') {
        uVar3 = 0xf0;
      }
                    /* WARNING: Could not recover jumptable at 0x42091a62. Too many branches */
    ...
    uVar2 = _DAT_ram_3fcc4434 / 100;
    UNRECOVERED_JUMPTABLE = *(code **)(_DAT_ram_3fcdfdd8 + 0x1b4);
  }
                    /* WARNING: Could not recover jumptable at 0x42091a28. Too many branches */
                    /* WARNING: Treating indirect jump as call */
