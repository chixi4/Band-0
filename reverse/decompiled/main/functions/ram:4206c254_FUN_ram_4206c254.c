...
undefined4
FUN_ram_4206c254(int param_1,undefined4 param_2,undefined4 param_3,undefined4 *param_4,byte *param_5
                ,int param_6)

{
  ...
  *param_4 = 0;
  ...
  if (param_6 - 4U < 0xd) {
    ...
    FUN_ram_4039c11e(param_5,param_1 + 0x158,param_6);
    if (((uVar9 | uVar6) & 0x1fffffff) != 0 || (uVar10 != 0 || uVar8 != 0)) {
      ...
      FUN_ram_4206b804(param_1,pbVar4);
      pbVar5 = param_5;
      do {
        bVar1 = *pbVar4;
        pbVar3 = pbVar5 + 1;
