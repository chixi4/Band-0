...
undefined4
FUN_ram_4206b05e(int *param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
...

{
  ...
  if (param_9 < (uint)(param_7 + param_11)) {
    ...
    if ((*(uint *)(*param_1 + 4) & 0xf000) == 0x6000) {
      iVar2 = param_1[0xf];
      *param_10 = param_7;
      uVar1 = FUN_ram_4206c380(iVar2,1,param_7,param_2,param_3,param_4,param_5,param_6,param_8,
