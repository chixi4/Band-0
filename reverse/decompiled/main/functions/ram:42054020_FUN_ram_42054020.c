...
undefined4 FUN_ram_42054020(int *param_1,int param_2,uint param_3,uint param_4)

{
  ...
  FUN_ram_4039c11e(param_1[1] + param_4,param_2,uVar3);
  if ((param_3 - uVar3 & 0xffff) != 0) {
    uVar1 = FUN_ram_42053fa4(*param_1,param_2 + uVar3);
    return uVar1;
  }
  return 0;
}
