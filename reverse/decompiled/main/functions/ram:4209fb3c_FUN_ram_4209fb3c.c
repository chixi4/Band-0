...
int FUN_ram_4209fb3c(uint param_1,uint param_2)

{
  ...
  if ((param_2 - 9 & 0xff) < 0x18) {
    ...
    if (param_1 == 0x1d) goto LAB_ram_4209fc6a;
LAB_ram_4209fb66:
    if (0x1d < param_1) {
      if (param_1 == 0x21) {
        if (((uint)(byte)(&DAT_ram_3c0fb04c)[param_2 >> 3] & 1 << (param_2 & 7)) == 0) {
          if (param_2 == 0x23) {
            return 0x21;
          }
          if (param_2 != 0x3f) {
      ...
      uVar2 = (uint)(byte)(&DAT_ram_3c0fb04c)[param_2 >> 3] & 1 << (param_2 & 7);
      if (param_1 == 0x1e) {
        if (uVar2 != 0) {
          return 0x1e;
        }
...
LAB_ram_4209fc50:
    ...
    if (param_1 == 0x1a) {
      iVar1 = 0x1b;
      goto LAB_ram_4209fc50;
    }
  }
  else {
    if (param_1 != 0x1d) goto LAB_ram_4209fb66;
    if (param_2 == 0x40) {
      return 1;
    }
  }
