...
ushort * FUN_ram_42060594(undefined4 param_1,int param_2,uint param_3,uint param_4,
...

{
  ...
  if ((param_4 <= param_3) && (0x17 < param_4)) {
    puVar2 = (ushort *)thunk_FUN_ram_403904a6(param_3 + 0x20);
    if (puVar2 != (ushort *)0x0) {
      FUN_ram_4039c11e(puVar2,param_2,param_4);
      ...
      *puVar4 = param_5[5];
      ...
      FUN_ram_4206038c(puVar2,puVar4,auStack_50,&uStack_64,auStack_60);
      iVar3 = FUN_ram_42060d4c(param_1,0x10,auStack_60,8,param_4 + 8 + param_2,param_3 - param_4,
