  ...
  do {
    while( true ) {
      ...
      if (iVar3 == 0) {
        ...
        thunk_FUN_ram_42091192(uVar9,0,uVar8);
        return;
      }
      (*(code *)&SUB_ram_40011d3c)(iVar3,0);
      FUN_ram_420b1d40(iVar3);
...
LAB_ram_420b1ea2:
    ...
    if ((uVar7 & 0x800000) != 0) {
      ...
      *puVar6 = uVar7 & 0xff7fffff;
      goto LAB_ram_420b1dfc;
    }
    if (*(char *)(iVar3 + 0x1a) != '\x05') goto LAB_ram_420b1ea2;
    FUN_ram_4207a038(6,0x40,3,&DAT_ram_3c1007f0);
  } while( true );
}
