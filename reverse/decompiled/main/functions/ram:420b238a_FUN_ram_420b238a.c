...
void FUN_ram_420b238a(int *param_1,int param_2)
    ...
    if ((uVar6 & 0x80) == 0) {
      if ((param_1[3] & 0xff00ff00U) == 0) {
        if ((((((short)param_1[6] == 0) || ((char)param_1[7] != '\0')) ||
          ...
          if ((byte)((char)puVar4[3] - 0x10U) < 0x10) goto LAB_ram_420b23c6;
        }
        else {
...
LAB_ram_420b23c6:
  ...
  if (*(char *)(gp + 0x712) != '\0') {
    cVar2 = (char)puVar4[3];
    if (*(char *)(gp + 0x711) == '\0') {
      if (2 < (byte)(cVar2 - 1U)) goto LAB_ram_420b2410;
      bVar5 = cVar2 + 4;
    }
    else {
      bVar5 = cVar2 - 4;
      if (3 < bVar5) goto LAB_ram_420b2410;
    }
    *(byte *)(puVar4 + 3) = bVar5;
  }
LAB_ram_420b2410:
  ...
  uStack_14 = iVar7 << 10;
  FUN_ram_4039cdcc(iVar1,_DAT_ram_6004d000,&uStack_14);
  uVar6 = 10;
  uVar8 = (uStack_14 - iVar3) + *(int *)(*(int *)(iVar1 + 0x24) + 0x18);
  if ((uVar8 < uStack_14) && (uVar6 = uVar8 >> 10, uVar6 == 0)) {
    uVar6 = 1;
  }
  FUN_ram_4039d910(param_1,uVar6);
  FUN_ram_42096330(param_1,_DAT_ram_3fcdfdec);
  return;
}
