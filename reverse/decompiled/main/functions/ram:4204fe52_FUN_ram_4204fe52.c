...

{
  ...
  if ((*(uint *)*param_1 & 0xf0) == 0x10) goto LAB_ram_4204fe90;
LAB_ram_4204fe88:
  FUN_ram_4039bf1e();
LAB_ram_4204fe90:
  iVar5 = (param_4 >> 1 & 4) + 8;
...
LAB_ram_4204feac:
    ...
    if ((int)uVar1 <= (int)param_3) {
      ...
      if (uVar1 <= *(ushort *)(aiStack_34[0] + 8)) goto code_r0x4204feea;
    }
  }
  goto LAB_ram_4204fe88;
code_r0x4204feea:
