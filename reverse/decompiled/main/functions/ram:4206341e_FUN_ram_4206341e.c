...
undefined4 FUN_ram_4206341e(int param_1,int param_2,undefined4 param_3)

{
  ...
  if (*(char *)(param_2 + 0x7c) != '\0') {
    ...
    *(int *)(param_1 + 0xd4) = iVar1;
    thunk_FUN_ram_420a3c58(param_3,param_1 + 200);
  }
  iVar1 = *(int *)(param_2 + 0x8c);
  if (iVar1 != 0) {
    iVar2 = *(int *)(param_1 + 0xd8);
    if (iVar2 == 0) {
      iVar2 = FUN_ram_4039c08e(1,6);
      *(int *)(param_1 + 0xd8) = iVar2;
      if (iVar2 == 0) {
        return 0;
      }
      FUN_ram_4039c11e(iVar2,iVar1,6);
    }
    thunk_FUN_ram_420a3c62(param_3,iVar2);
  }
  if (*(int *)(param_2 + 0x90) != 0) {
    FUN_ram_420a3c36(param_3);
  }
  return 1;
}
