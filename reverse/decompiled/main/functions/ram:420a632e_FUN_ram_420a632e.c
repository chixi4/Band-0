...
undefined4 FUN_ram_420a632e(int *param_1,undefined1 *param_2,undefined1 *param_3,int *param_4)
...
LAB_ram_420a6310:
    ...
    if (psVar6 != (short *)0x0) {
      for (; sVar1 = *psVar6, sVar1 != 0; psVar6 = psVar6 + 1) {
        if ((param_1[2] == 0x303) && (iVar4 = FUN_ram_420a5210(sVar1), iVar4 != 0)) {
          if ((param_3 < puVar2) || ((int)param_3 - (int)puVar2 < 2)) goto LAB_ram_420a6310;
