...
int FUN_ram_4205cf90(int *param_1,int param_2,int param_3,int *param_4)
        ...
        for (; puVar3 != (undefined4 *)0x0; puVar3 = (undefined4 *)puVar3[2]) {
          if (((puVar3[1] != 0) && (param_2 <= iVar6)) && (iVar6 < iVar5)) {
            iVar4 = (*(code *)&SUB_ram_400106ac)
                              (param_3 + iVar2,*param_4 - iVar2,0x3c07329c,*puVar3);
            iVar2 = iVar2 + iVar4;
          }
          iVar6 = iVar6 + 1;
        }
        if (bVar1) {
          iVar6 = (*(code *)&SUB_ram_400106ac)(param_3 + iVar2,*param_4 - iVar2,0x3c0713a4);
          iVar2 = iVar2 + iVar6;
        }
        *param_4 = iVar2;
        iVar6 = iVar5;
