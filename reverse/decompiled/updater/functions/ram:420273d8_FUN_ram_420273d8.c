...
undefined4 FUN_ram_420273d8(int *param_1,undefined4 param_2,uint param_3,uint param_4)

{
  ...
  iVar3 = *(int *)((uVar2 >> 0x18 & 0x7c) + 0x3c077be0);
  param_1[1] = param_3;
  param_1[2] = param_4;
  if (param_4 != 1) {
    if (((uVar2 & 0xf000) != 0x3000) && ((uVar2 & 0xe000) != 0x4000)) {
      UNRECOVERED_JUMPTABLE = *(code **)(iVar3 + 0x20);
      goto LAB_ram_42027434;
    }
  }
  UNRECOVERED_JUMPTABLE = *(code **)(iVar3 + 0x1c);
LAB_ram_42027434:
                    /* WARNING: Could not recover jumptable at 0x42027434. Too many branches */
