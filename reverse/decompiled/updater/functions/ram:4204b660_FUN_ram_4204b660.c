...
uint FUN_ram_4204b660(int *param_1,undefined4 param_2)

{
  ...
  if (uVar9 != 0) {
    ...
    *(undefined1 *)(*(int *)(iVar2 + 0x24) + 0xd) = 0x7f;
    ...
    for (uVar8 = 1; uVar8 < uVar9; uVar8 = uVar8 + 1 & 0xff) {
      if (iVar7 == 0) {
        FUN_ram_42033fd8(6,0x800,1,0x3c07df00,0x3c072f4c,0x3c079250,0x22a);
        do {
  ...
  iVar2 = *param_1;
  if (iVar2 == 0) {
    FUN_ram_42033fd8(6,0x800,1,0x3c07df18,0x3c072f4c,0x3c079250,0x232);
    do {
                    /* WARNING: Do nothing block with infinite loop */
    } while( true );
  }
  ...
  if ((*puVar3 & 0x80) == 0) {
    if (uVar9 < *(byte *)(param_1 + 7)) {
      ...
      *(undefined4 *)(iVar2 + 0x20) = 0;
      ...
      iVar7 = iVar4;
      if (iVar4 == 0) {
        FUN_ram_42033fd8(6,0x800,1,0x3c07df3c,0x3c072f4c,0x3c079250,0x237);
        do {
                    /* WARNING: Do nothing block with infinite loop */
        } while( true );
      }
