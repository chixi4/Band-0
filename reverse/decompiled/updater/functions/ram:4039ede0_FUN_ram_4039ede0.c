...
int FUN_ram_4039ede0(int param_1,int param_2,uint param_3,uint param_4)

{
  int iVar1;
  int iVar2;
  
  iVar1 = (*_DAT_ram_3fcb0efc)(param_3,param_4);
  if (iVar1 == 0) {
    iVar1 = 0x106;
  }
  else {
...
LAB_ram_4039ee38:
        ...
        iVar1 = 0x10;
        if ((param_3 & 0x1f) == 0) goto LAB_ram_4039ee38;
      }
      (*_DAT_ram_3fcb0ef0)(param_3,param_2,iVar1);
