...
int FUN_ram_4039df2c(undefined4 *param_1,undefined1 *param_2,uint param_3,uint param_4)

{
  ...
  puStack_54 = param_1;
  iVar2 = (*(code *)_DAT_ram_3fcb0e08[2])(&puStack_54);
  if (iVar2 == 0) {
      ...
      if (((param_2 == (undefined1 *)0x0) || ((uint)puStack_54[5] < param_3)) ||
        ...
        while( true ) {
          ...
          if (cVar1 == '\0' && (undefined1 *)0x3ffff < puVar5) {
            ...
            FUN_ram_40399daa(auStack_50,param_2,uVar6);
          ...
          iVar2 = (*(code *)*_DAT_ram_3fcb0e08)(puStack_54);
          if (iVar2 != 0) {
            uVar4 = 0;
            goto LAB_ram_4039e042;
          }
          uVar7 = uVar7 - uVar6;
          iVar2 = (**(code **)(puStack_54[1] + 0x44))(puStack_54,puStack_58,uVar8,uVar6);
          if (iVar2 != 0) break;
          if (uVar7 == 0) {
            iVar2 = (*(code *)_DAT_ram_3fcb0e08[3])
                              (puStack_54,0,1,param_3,param_4,(code *)_DAT_ram_3fcb0e08[3]);
            return iVar2;
          }
          iVar2 = (*(code *)_DAT_ram_3fcb0e08[1])(puStack_54,0);
          if (iVar2 != 0) break;
          uVar8 = uVar8 + uVar6;
        ...
        uVar4 = 1;
LAB_ram_4039e042:
        (*(code *)_DAT_ram_3fcb0e08[3])(puStack_54,iVar2,uVar4,param_3,param_4);
      }
    }
  }
  return iVar2;
