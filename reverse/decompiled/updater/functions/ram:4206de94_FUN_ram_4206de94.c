...
int FUN_ram_4206de94(int *param_1,int param_2)

{
  ...
  *(undefined1 *)(iVar7 + 2) = uVar2;
  FUN_ram_40399daa(iVar4,param_1 + 0x2e,8);
  ...
  *puVar5 = (char)((uint)iVar8 >> 8);
  ...
  if (iVar4 != 0) {
    ...
    iStack_2c = 0x114d - (iStack_30 - param_1[0x25]);
    iStack_24 = param_1[0x2c];
    iStack_28 = param_1[0x2a] - iStack_30;
    FUN_ram_40399daa(auStack_3c,param_1[0x26],8);
    bStack_34 = (byte)param_1[0x2b];
    uStack_33 = uVar3;
    uStack_32 = uVar2;
    iVar8 = FUN_ram_4206d608(param_1,iVar4,auStack_3c,*(undefined4 *)(*param_1 + 0x1c),
  ...
  *puVar5 = (char)param_1[0x2b];
  ...
  FUN_ram_4206de14(param_1,param_1[0x10]);
  ...
  do {
    ...
    *pcVar6 = cVar1 + '\x01';
    if (cVar1 != -1) {
      ...
      iVar8 = FUN_ram_4206de36(param_1);
      return iVar8;
    }
    pcVar6 = pcVar6 + -1;
  } while (iVar8 != 0);
