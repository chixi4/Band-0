...
int FUN_ram_40398d84(int *param_1,int param_2,uint param_3)

{
  ...
  if ((param_1 == (int *)0x0) || (iVar16 = *param_1, iVar16 == 0)) {
    FUN_ram_42033fd8(1,0x800,1,0x3c07cf80,0x3c072634,0x7d4);
    do {
                    /* WARNING: Do nothing block with infinite loop */
    } while( true );
  }
  (*(code *)&SUB_ram_40011fd0)(_DAT_ram_3fcb4f84 != iVar16,auStack_48);
  iVar17 = *(int *)(param_2 + 4);
  pbVar5 = *(byte **)(iVar17 + 4);
  FUN_ram_40399daa(auStack_40,pbVar5,0xe);
  ...
  *(undefined2 *)(puVar6 + 2) = 0;
  if (iVar17 == 0) {
    puVar6[1] = 1;
    FUN_ram_40399daa(puVar6 + 4,param_1 + 1,6);
    FUN_ram_40399daa(puVar6 + 10,auStack_3a,6);
    puVar7 = auStack_40;
  }
  else {
    if (iVar17 != 1) {
    ...
    puVar6[1] = 2;
    FUN_ram_40399daa(puVar6 + 4,auStack_40,6);
    FUN_ram_40399daa(puVar6 + 10,auStack_48,6);
    puVar7 = auStack_3a;
  }
  FUN_ram_40399daa(puVar6 + 0x10,puVar7,6);
  uVar10 = param_3 & 0xff;
  if (bVar3) {
    ...
    if (((uVar15 != 0) && ((uVar13 & 0x2000002) == 0)) &&
      ...
      if (iVar17 != 0) {
        if ((*(ushort *)(iVar17 + 0x2c) & 4) != 0) {
          ...
          goto LAB_ram_40399048;
        }
        if ((*(ushort *)(iVar17 + 0x2c) & 0x16) != 0) goto LAB_ram_40399048;
      }
      iVar17 = FUN_ram_420361d4(param_1,uVar10);
      if ((iVar17 != 0) && (_DAT_ram_3fcb3f70 != 0)) {
        FUN_ram_420361f2(param_1,uVar10);
      }
    }
  }
LAB_ram_40399048:
