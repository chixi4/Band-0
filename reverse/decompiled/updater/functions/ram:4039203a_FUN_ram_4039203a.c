...
/* WARNING: Removing unreachable block (ram,0x40392098) */

int FUN_ram_4039203a(int param_1)

{
  ...
  iVar8 = 0;
  do {
    puVar2 = *(ulonglong **)(param_1 * 4 + 0x3fcb6724);
    uVar12 = FUN_ram_40391212();
    ...
    if (puVar2 == (ulonglong *)0x0) {
      if (iVar8 != 0) {
        ...
        iVar11 = -1;
LAB_ram_40392138:
        FUN_ram_4039123a(uVar6,iVar11,param_1);
      }
LAB_ram_4039214e:
      FUN_ram_40391f3a();
      return iVar8;
    ...
    uVar6 = (uint)*puVar2;
    if (uVar12 < *puVar2) {
      if ((param_1 == 0) || (iVar8 != 0)) goto LAB_ram_40392138;
      goto LAB_ram_4039214e;
    }
    iVar8 = (int)puVar2[3];
    if (iVar8 != 0) {
