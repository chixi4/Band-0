...
undefined4 FUN_ram_4201ae9e(undefined4 *param_1,int param_2)
...
LAB_ram_4201aee0:
  ...
  *param_1 = uVar11;
  ...
  uVar4 = FUN_ram_4201ae6a(param_2);
  iVar8 = 0;
  if (-0x1a < iVar7) {
    iVar8 = (iVar7 + 1) / 0x19;
  }
  *(char *)(param_1 + 3) = (char)(iVar8 / (int)(40000000 / (40000000 / uVar4)));
  if (*(int *)(param_2 + 0x20) == 0) {
    bVar3 = FUN_ram_4201ae6a(param_2);
    uVar4 = 0x80000000;
    if (bVar3 != 1) {
      uVar4 = bVar3 - 1;
    ...
    uVar5 = FUN_ram_4201ae6a(param_2);
    uVar4 = 0x80000000;
    if ((uVar5 & 0xff) != 1) {
      uVar4 = (uVar5 & 0xff) - 1;
