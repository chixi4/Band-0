...
void FUN_ram_40393726(uint param_1,undefined4 param_2,int param_3,int param_4)

{
  ...
  iVar2 = (**(code **)(_DAT_ram_3fcb640c + 0x24))(param_1);
  ...
  *puVar3 = param_4 << 0x10 | param_1 | param_3 << 8 | 0x5000000;
  ...
  thunk_FUN_ram_40393ae0();
                    /* WARNING: Could not recover jumptable at 0x403937a0. Too many branches */
