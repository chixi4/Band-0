...
undefined4 FUN_ram_420774fc(undefined4 *param_1,undefined4 *param_2)
...
LAB_ram_42077572:
    ...
    if ((uVar2 & 3) != 0) {
      *(undefined2 *)(param_2 + 3) = 1;
      FUN_ram_42077468(0x3fcb0cec,0x420674d0,&DAT_ram_3fcb0ce0);
      *(ushort *)(param_2 + 3) = uVar2;
      if ((uVar2 & 9) == 9) {
        FUN_ram_42076f8e(param_1,param_2);
      }
    }
    *param_2 = param_2[4];
