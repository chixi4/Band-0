...
int FUN_ram_4039dc90(undefined4 *param_1)

{
  ...
  if (((piVar3 != (int *)0x0) && (*piVar3 != 0)) && (piVar3[1] != 0)) {
    ...
    if (uVar5 < 0x10) {
      iVar4 = 0xb;
      do {
        iVar1 = FUN_ram_4207bb12(param_1,&uStack_28);
        if (iVar1 != 0x6003) {
          if (iVar1 != 0) {
            return iVar1;
          }
          goto LAB_ram_4039dcc8;
        }
        iVar4 = iVar4 + -1;
        iVar1 = 0x6003;
      } while (iVar4 != 0);
...
LAB_ram_4039dcc8:
      param_1[6] = uStack_28;
      iVar1 = FUN_ram_4039da32(param_1);
      if (((iVar1 != 0) || (iVar1 = FUN_ram_4039d9b6(param_1), iVar1 == 0)) &&
         (iVar1 = FUN_ram_4039dc28(param_1,auStack_24), iVar1 == 0)) {
        if (((*(code **)(param_1[1] + 0x74) != (code *)0x0) &&
            (uVar2 = (**(code **)(param_1[1] + 0x74))(param_1), (uVar2 & 2) == 0)) &&
           (0x1000000 < auStack_24[0])) {
          auStack_24[0] = 0x1000000;
        }
        iVar1 = (*(code *)*_DAT_ram_3fcb0e08)(param_1);
        if (iVar1 == 0) {
          if ((0xf < uVar5) ||
