...
int FUN_ram_42027a50(int *param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
  ...
  if (param_7 < param_11) {
    ...
    if (param_7 <= param_9) {
      ...
      if ((*(uint *)(*param_1 + 4) & 0xf000) == 0x6000) {
        *param_10 = param_7;
        iVar1 = FUN_ram_42028d6c(param_1[0xf],param_7,param_2,param_3,param_4,param_5,
