...

{
  ...
  do {
    do {
      if (_DAT_ram_3fcb5fa8 == (int *)&DAT_ram_3fcb5fa8) {
LAB_ram_4205f1a0:
        fence();
        DAT_ram_3fcb5fc5 = 0;
        fence();
...
LAB_ram_4205f156:
      ...
      (**(code **)(_DAT_ram_3fcb6854 + 0x54))(_DAT_ram_3fcb6870);
      FUN_ram_4205eddc();
      FUN_ram_4205edc2(iVar7 * 1000 + iVar3 / 1000);
      (**(code **)(_DAT_ram_3fcb6854 + 0x58))(_DAT_ram_3fcb6870);
      goto LAB_ram_4205f1a0;
    }
    if ((local_40 == uVar6) && (uStack_3c == uVar2)) {
      if (iStack_38 < piVar1[4]) goto LAB_ram_4205f156;
    }
    iVar11 = piVar1[9];
    iVar3 = piVar1[6];
    iVar7 = piVar1[7];
    if (iVar11 == 0) {
      ...
      FUN_ram_4205edf2(piVar1);
      (*pcVar10)(iVar3,iVar7);
    }
    else {
      (**(code **)(_DAT_ram_3fcb6854 + 0x54))(_DAT_ram_3fcb6870);
      piVar9 = (int *)*_DAT_ram_3fcb5fa8;
      piVar8 = _DAT_ram_3fcb5fa8;
      while (piVar4 = piVar9, piVar8 != (int *)&DAT_ram_3fcb5fa8) {
        if (piVar1 == piVar8) {
          iVar5 = *piVar1;
          piVar9 = (int *)piVar1[1];
          *(int **)(iVar5 + 4) = piVar9;
