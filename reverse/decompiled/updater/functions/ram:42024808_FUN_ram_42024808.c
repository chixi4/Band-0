...
int FUN_ram_42024808(int *param_1,undefined4 *param_2,undefined4 param_3)

{
  ...
  iVar3 = FUN_ram_4202479e(param_1,*(undefined2 *)((int)param_2 + 6));
  if (iVar3 == 0) {
    ...
    *(ushort *)(param_1 + 1) =
         ...
         1;
    FUN_ram_4202622a(*param_1,uVar5,uVar1,uVar4);
