...
void FUN_ram_42010518(int *param_1)

{
  ...
  FUN_ram_4201a6ac();
  thunk_FUN_ram_4201b5ec();
  FUN_ram_4201066c();
  FUN_ram_42010816();
  _DAT_ram_3fcb6580 = FUN_ram_42011284();
  iVar4 = 0;
  do {
    iVar2 = iVar4 + 1;
  ...
  FUN_ram_42010976();
  uVar1 = _DAT_ram_3fcb6580;
  if (DAT_ram_3c070000 != -0x17) {
    FUN_ram_40399b58();
    uVar1 = _DAT_ram_3fcb6580;
  }
  _DAT_ram_3fcb6584 = (undefined4)((ulonglong)uVar1 >> 0x20);
  _DAT_ram_3fcb6580 = (undefined4)uVar1;
  return;
}
