...
int FUN_ram_42043e00(int param_1,int param_2,int param_3)

{
  ...
  if (param_1 == 0) {
    FUN_ram_42033fd8(1,0x800,1,0x3c07dabc,0x3c072ea0,0x9a);
    do {
  ...
  if ((*(byte *)(iVar4 + 4) & 1) == 0) {
    puVar7 = &DAT_ram_3fcb4f74;
    puVar3 = (undefined1 *)((*(byte *)(param_1 + 0x134) + 0x4c) * 4);
    goto LAB_ram_42043e8c;
  }
  pbVar5 = (byte *)(iVar4 + param_3);
  bVar1 = pbVar5[3];
  if ((bVar1 & 0x20) == 0) {
    if (*(char *)(param_1 + 0x28b) == '\b') goto LAB_ram_42043e7a;
