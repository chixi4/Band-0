...
undefined4 FUN_ram_42061f02(char *param_1,uint param_2,undefined4 *param_3)

{
  ...
  *param_3 = 2;
  ...
  if (param_2 - 4 < 4) {
    ...
    uVar2 = FUN_ram_42061da8(param_1 + 4);
    param_3[2] = uVar2;
    uVar5 = param_2 - 8;
    if (uVar5 < 2) {
      uVar2 = 0xfffffffb;
      ...
      pcVar10 = pcVar1;
      do {
        uVar3 = FUN_ram_42061da8(pcVar10);
        uVar5 = uVar5 | uVar3;
        param_3[1] = uVar5;
        iVar9 = iVar9 + 1;
        pcVar10 = pcVar10 + 4;
      ...
      if (1 < (int)uVar3) {
        ...
        pcVar12 = pcVar10;
        do {
          iVar4 = FUN_ram_42061d8a(pcVar12);
          uVar3 = 1;
          if ((((iVar4 != 0xfac01) && (uVar3 = 2, iVar4 != 0xfac02)) &&
              (uVar3 = 0x400, iVar4 != 0xfac08)) &&
             (((uVar3 = 0x4000000, iVar4 != 0xfac18 && (uVar3 = 0x80, iVar4 != 0xfac05)) &&
              (uVar3 = 0x100, iVar4 != 0xfac06)))) {
            uVar3 = (uint)(iVar4 == 0xfac12) << 0x16;
          }
          uVar6 = uVar6 | uVar3;
          param_3[3] = uVar6;
          iVar11 = iVar11 + 1;
        ...
        if (uVar6 <= uVar5 >> 4) {
          ...
          uVar2 = FUN_ram_42061da8(pcVar10 + iVar11 + 8 + uVar6 * 0x10);
          param_3[7] = uVar2;
          iVar7 = FUN_ram_42061e92();
          if (iVar7 != 0) {
            return 0;
          }
          return 0xfffffff6;
