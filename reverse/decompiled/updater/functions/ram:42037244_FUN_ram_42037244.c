...
undefined1 * FUN_ram_42037244(undefined1 *param_1,int *param_2)

{
  ...
  if ((param_2 == (int *)0x0) || (iVar5 = *param_2, iVar5 == 0)) {
    FUN_ram_42033fd8(1,0x800,1,0x3c07d1e4,0x3c072718,0xad1);
    do {
                    /* WARNING: Do nothing block with infinite loop */
    } while( true );
  }
  (*(code *)&SUB_ram_40010488)(param_1,0,0x16);
  puVar1 = (undefined1 *)FUN_ram_420339fc();
  *param_1 = *puVar1;
...
LAB_ram_42037334:
    ...
    bVar4 = bVar4 | 3;
    goto LAB_ram_42037334;
  }
  if (*(char *)(iVar5 + 299) == '\x01') {
    bVar4 = *(char *)(iVar5 + 0x12a) - 1;
  }
  else {
    if (*(char *)(iVar5 + 299) != '\x02') goto LAB_ram_420372ea;
