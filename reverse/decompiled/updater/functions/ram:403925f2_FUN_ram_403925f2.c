...
void FUN_ram_403925f2(int param_1,int *param_2)

{
  ...
  if (((param_2 != (int *)0x0) && (iVar2 = *(int *)(*param_2 + 0x18), iVar2 != 0)) &&
    ...
    iStack_30 = iVar2;
    iVar2 = FUN_ram_40398506(&uStack_3c,param_1 + 0x4c);
    bVar1 = iVar2 == 0;
  }
  iVar2 = FUN_ram_40391c6e(uVar5);
  if ((iVar2 != 0) || (bVar1)) {
    FUN_ram_40398310(iVar4 + 0x20,param_1 + 0x3c);
