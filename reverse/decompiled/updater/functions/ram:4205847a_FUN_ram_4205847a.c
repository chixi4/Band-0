...
void FUN_ram_4205847a(int param_1,int param_2,int param_3)

{
  ...
  uStack_28 = _DAT_ram_3c0793d4;
  iVar3 = FUN_ram_42051d86(0x36,8,0x280);
  if (iVar3 != 0) {
    ...
    if (param_3 == 0x16) {
      ...
      *(undefined1 *)(param_2 + 8) = 1;
      ...
      puVar1[6] = uVar5;
      puVar1[7] = uVar6;
      puVar8 = &DAT_ram_3fcb6818;
    }
    *puVar1 = (char)param_3;
    puVar1[1] = 0;
    puVar1[2] = 0;
    puVar1[3] = 0;
    uVar2 = FUN_ram_4205b3ae(puVar1,8);
    puVar1[2] = (char)uVar2;
    puVar1[3] = (char)((ushort)uVar2 >> 8);
    auStack_24[0] = 0x494;
    FUN_ram_42058fc8(iVar3,&uStack_28,puVar8,1,0,2,param_1,auStack_24,4);
