...
int FUN_ram_4039dc28(int param_1,undefined4 *param_2)

{
  ...
  iVar1 = (*(code *)_DAT_ram_3fcb0e08[2])(aiStack_24);
  if (iVar1 == 0) {
    iVar1 = 0x6005;
    if (((*(int *)(*(int *)(aiStack_24[0] + 4) + 0x10) != 0) &&
        (iVar1 = 0x102, param_2 != (undefined4 *)0x0)) &&
       (iVar1 = (*(code *)*_DAT_ram_3fcb0e08)(aiStack_24[0]), iVar1 == 0)) {
      ...
      iVar1 = (*(code *)_DAT_ram_3fcb0e08[1])();
    }
  }
  return iVar1;
}
