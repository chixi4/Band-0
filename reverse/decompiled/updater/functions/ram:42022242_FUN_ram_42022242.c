...
void FUN_ram_42022242(ushort *param_1,byte *param_2,undefined1 *param_3,int *param_4,byte *param_5)
...
LAB_ram_420222c0:
  ...
  *param_3 = (char)(uVar4 & 0xffffc7ff);
  FUN_ram_40399daa(param_3 + 2,param_1 + 2,0x12);
  uVar4 = (bVar1 == 3) - 1;
  param_3[0x14] = (byte)param_1[0xb] & 0xf;
  param_3[0x15] = 0;
  iVar2 = FUN_ram_40399daa(param_3 + 0x16,param_1 + 0xc,((uVar4 & 0xfffffffd) + 3 + iVar7) * 2);
  ...
  *param_4 = (int)pbVar6 - (int)param_3;
  FUN_ram_40399daa(param_5 + 1,param_1 + 5,6);
  param_5[7] = param_2[7];
  param_5[8] = param_2[6];
  param_5[9] = param_2[5];
