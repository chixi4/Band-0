...
undefined4 FUN_ram_42035fc6(int *param_1,undefined4 param_2,int param_3)

{
  ...
  uVar4 = _DAT_ram_3fcb3f80;
  if (param_1 == (int *)0x0) {
    FUN_ram_42033fd8(1,0x800,1,0x3c07d21c,0x3c072718,0xb2a);
    do {
  ...
  if ((*(uint *)(*param_1 + 300) & 0x200000) != 0) {
    iVar6 = FUN_ram_42035e86(param_1,uVar5,uVar3,bVar1);
    if (iVar6 != 1) {
LAB_ram_420360d6:
      uStack_3a = 0;
      goto LAB_ram_420360d8;
    }
    if ((*param_1 == _DAT_ram_3fcb4f84) && (uVar10 == 0)) {
      for (uVar9 = *(ushort *)(param_1 + 0xa2); uVar9 != 0; uVar9 = uVar9 & 0xfffe) {
        uVar7 = (*(code *)&SUB_ram_400108ec)(uVar9);
        if (uVar7 != 0) {
          FUN_ram_42035c86(param_1,uVar7 & 0xff);
          uStack_44 = (undefined2)uVar7;
          uStack_42 = 0;
          uStack_40 = 1;
          FUN_ram_420445a0(param_1,3,2,&uStack_44);
          break;
        }
      }
      iVar6 = FUN_ram_42035e86(param_1,uVar5,uVar3,bVar1);
      if (iVar6 != 1) goto LAB_ram_420360d6;
    }
  }
  uStack_3a = 1;
LAB_ram_420360d8:
  ...
  uStack_36 = 0;
  uStack_34 = 0;
  FUN_ram_420445a0(param_1,3,1,&uStack_3c);
  return 0;
}
