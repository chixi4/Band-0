...
undefined4 FUN_ram_42037036(int *param_1,char *param_2)

{
  ...
  if ((param_1 == (int *)0x0) || (iVar4 = *param_1, iVar4 == 0)) {
    FUN_ram_42033fd8(1,0x800,1,0x3c07d1c4,0x3c072718,0x9c3);
    do {
  ...
  if (param_2 != (char *)0x0) {
    ...
    do {
      if (((int)(uint)(byte)param_2[((int)uVar2 >> 3) + 5] >> (uVar2 & 7) & 1U) != 0) {
        ...
        if ((int)uVar2 < 0x20) {
          if ((int)uVar2 < (int)(uVar3 << 3)) goto LAB_ram_42037120;
        }
        else if (uVar2 == 0x20) {
...
LAB_ram_42037120:
        ...
        else if ((int)uVar2 <= iVar5) goto LAB_ram_42037120;
      }
      uVar2 = uVar2 + 1;
    } while (uVar2 != 0x7f);
  }
