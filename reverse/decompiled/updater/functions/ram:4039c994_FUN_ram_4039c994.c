...
int FUN_ram_4039c994(int param_1)

{
  ...
  if ((*(code **)(_DAT_ram_3fcb1020 + 0x10) == (code *)0x0) ||
     (iVar4 = (**(code **)(_DAT_ram_3fcb1020 + 0x10))(), iVar4 == 0)) {
    iVar4 = (uint)*(byte *)(param_1 + 0x181) << 10;
  }
  else {
    FUN_ram_4207959e(&uStack_38,auStack_34);
  ...
  if (((*(char *)(param_1 + 0x168) != '\0') && (*(char *)(param_1 + 0x1d4) == '\0')) &&
     (*(char *)(param_1 + 0xe) != '\0')) {
    iVar6 = FUN_ram_4039bd14();
    if (iVar6 == 0) {
LAB_ram_4039cab6:
      if (*(short *)(param_1 + 0x186) <= *(short *)(param_1 + 0x184)) goto LAB_ram_4039c9d4;
    }
    else if (*(short *)(param_1 + 0x186) <= *(short *)(param_1 + 0x184)) {
      *(undefined2 *)(param_1 + 0x184) = 0;
      goto LAB_ram_4039cab6;
    }
    if ((*(code **)(_DAT_ram_3fcb1020 + 0xc) == (code *)0x0) ||
       (iVar6 = (**(code **)(_DAT_ram_3fcb1020 + 0xc))(), iVar6 == 0)) {
      FUN_ram_42049986();
      (**(code **)(_DAT_ram_3fcdfdd8 + 0xf0))(param_1 + 0x16c,(uint)bVar1 * 0x400 + iVar4,0);
      iVar4 = FUN_ram_4039bd34(param_1);
      if (iVar4 != 0) {
        FUN_ram_4039bd94(param_1);
        goto LAB_ram_4039c9d6;
      }
    }
  }
LAB_ram_4039c9d4:
