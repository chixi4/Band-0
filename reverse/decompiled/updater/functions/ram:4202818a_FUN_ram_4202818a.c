...
void FUN_ram_4202818a(int param_1,int param_2,undefined1 *param_3)

{
  ...
  if (*(char *)(param_1 + 0x189) == '\0') {
    ...
    uStack_1c = (uint)*(ushort *)((puVar5[2] & 0xf) * 2 + 0x3c077f08) << 0x10 ^ puVar5[1] >> 4;
    ...
    do {
      ...
      uStack_1c = (uint)*(ushort *)(uVar4 * 2 + 0x3c077f08) << 0x10 ^ uStack_1c >> 4;
      ...
      uStack_14 = local_20 << 0x1c | uStack_14 >> 4;
      local_20 = uStack_1c << 0x1c | local_20 >> 4;
      uStack_1c = (uint)*(ushort *)((uStack_18 & 0xf) * 2 + 0x3c077f08) << 0x10 ^ uStack_1c >> 4;
      uStack_18 = uVar3 | uStack_18 >> 4;
