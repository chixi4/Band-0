...
int FUN_ram_42071660(int param_1,undefined4 *param_2)

{
  ...
  iVar2 = FUN_ram_42066f6e(param_2);
  if ((iVar2 == 1) || (iVar2 == 6)) {
    uVar3 = FUN_ram_42066f60(param_2);
...
LAB_ram_42071690:
    ...
    if (iVar2 - 2U < 3) {
      ...
      uVar7 = FUN_ram_42066f6e(&uStack_28);
      ...
      if (2 < iVar2 - 2U) {
        ...
        if ((uVar3 == extraout_a2) &&
           (iVar4 = FUN_ram_42071570(iVar5,*(undefined4 *)(iVar2 + 6)), iVar4 == 0)) {
          return 0;
        }
        ...
        if (((2 < uVar3) && (pcVar6 = *(char **)(iVar2 + 6), *pcVar6 == '*')) && (pcVar6[1] == '.'))
        {
          for (iVar2 = 0; iVar4 != iVar2; iVar2 = iVar2 + 1) {
            if (*(char *)(iVar5 + iVar2) == '.') {
              ...
              iVar2 = FUN_ram_42071570(pcVar6 + 1);
              return -(uint)(iVar2 != 0);
            }
          }
        }
