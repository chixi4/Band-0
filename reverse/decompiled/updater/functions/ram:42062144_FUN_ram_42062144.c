...
undefined4 FUN_ram_42062144(char *param_1,uint param_2,undefined4 *param_3)

{
  ...
  *param_3 = 1;
  ...
  iVar3 = FUN_ram_42061d8a(param_1 + 2);
  if (iVar3 != 0x50f201) {
    return 0xfffffffe;
  }
  ...
  if (param_2 - 8 < 4) {
    ...
    uVar4 = FUN_ram_42061e16(param_1 + 8);
    param_3[2] = uVar4;
    uVar7 = param_2 - 0xc;
    if (uVar7 < 2) {
      uVar4 = 0xfffffffb;
      ...
      pcVar10 = pcVar1;
      do {
        uVar5 = FUN_ram_42061e16(pcVar10);
        uVar7 = uVar7 | uVar5;
        param_3[1] = uVar7;
        iVar8 = iVar8 + 1;
        pcVar10 = pcVar10 + 4;
      ...
      if (1 < (int)uVar7) {
        ...
        if ((int)(uVar7 << 2) <= iVar3) {
          ...
          do {
            iVar6 = FUN_ram_42061d8a(pcVar10);
            uVar5 = 1;
