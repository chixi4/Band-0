...
undefined4 FUN_ram_4202878e(int param_1,undefined1 param_2,int param_3,uint param_4)

{
  ...
  if (param_4 == 0) {
    ...
    *(undefined4 *)(param_1 + 0x154) = 0;
    if (param_4 == 0xc) {
      FUN_ram_40399daa(pbVar6,param_3,0xc);
      *(undefined1 *)(param_1 + 0x177) = 1;
      ...
      do {
        ...
        FUN_ram_4202818a(param_1,pbVar6,pbVar6);
    ...
    uVar2 = FUN_ram_420274c2(param_1,pbVar6,0x10,param_1 + 0x158,&uStack_44);
  }
  return uVar2;
}
