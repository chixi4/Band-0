...
int FUN_ram_4202839a(int param_1,int param_2,int param_3,int param_4,int param_5,int param_6)

{
  ...
  uStack_24 = 0;
  iVar2 = FUN_ram_420274c2(param_1,param_1 + 0x168,0x10,param_2,&uStack_24);
  if (iVar2 == 0) {
