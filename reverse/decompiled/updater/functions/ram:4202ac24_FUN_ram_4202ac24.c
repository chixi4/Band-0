...
undefined4 FUN_ram_4202ac24(uint *param_1,undefined4 param_2)

{
  ...
  FUN_ram_4202ac0e(param_1,0x3c078220,iVar4 - (uVar1 & 0x3f));
  FUN_ram_4202aaa4(param_1,&uStack_18);
  uVar2 = 0x1c;
  if (param_1[0x1b] != 1) {
    uVar2 = 0x20;
  }
  FUN_ram_40399daa(param_2,param_1 + 2,uVar2);
  return 0;
}
