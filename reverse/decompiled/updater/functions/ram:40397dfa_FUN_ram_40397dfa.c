...
undefined4 FUN_ram_40397dfa(int *param_1,uint param_2,uint param_3,uint param_4)
  ...
  *puVar1 = *puVar1 | 0x40000;
  ...
  if (param_4 != 0) {
    if (((param_2 | param_4) & 3) == 0) {
      FUN_ram_40399daa(param_2,puVar1 + 0x16,param_4);
    }
    else {
      uVar5 = param_4 + 3;
      for (uVar2 = 0; uVar5 >> 2 != uVar2; uVar2 = uVar2 + 1) {
        ...
        FUN_ram_40399daa(param_2,&uStack_24,uVar4);
