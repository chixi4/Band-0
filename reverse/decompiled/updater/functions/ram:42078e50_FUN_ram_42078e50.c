...
void FUN_ram_42078e50(int *param_1)

{
  ...
  if (*(char *)((int)param_1 + 0x12) != '\x06') {
    FUN_ram_42033fd8(6,0x800,1,0x3c07deac,0x3c072f4c,0x3c079214,0x32f);
    do {
  ...
  *param_1 = 0;
  ...
  if (*(byte *)((int)puVar3 + 6) < *(byte *)(gp + 0x5c5)) {
    if (*(byte *)((int)puVar3 + 7) < *(byte *)(gp + 0x5c4)) {
      uVar2 = 4;
    }
    else {
      uVar2 = 3;
  ...
  FUN_ram_4204b592(param_1,iVar1,uVar2,1);
  return;
}
