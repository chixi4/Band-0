...
uint FUN_ram_42034714(int param_1)

{
  ...
  if ((iVar2 != 0) && (bVar4 = *(byte *)(iVar2 + 1), *(short *)(iVar2 + 6) == 1)) {
    DAT_ram_3fcb512c = 3;
    DAT_ram_3fcb5130 = FUN_ram_420340a2(iVar2 + 8,auStack_31);
    ...
    for (iVar6 = bVar4 - 0xc; 0 < iVar6; iVar6 = iVar6 + -4) {
        ...
        if (_DAT_ram_3fcb50ec == 0) {
          *(undefined1 *)(param_1 + 0x60) = 2;
          ...
          if ((9 < (DAT_ram_3fcb512d - 4 & 0xff)) ||
            ...
            FUN_ram_42033fd8(1,8,4,0x3c07abd8);
      ...
      bVar4 = FUN_ram_420340a2(iVar8,auStack_31);
      if (DAT_ram_3fcb512e < 2) {
        DAT_ram_3fcb512e = bVar4;
      }
      uVar7 = uVar7 + 1;
      iVar8 = iVar8 + 4;
    }
