...
void FUN_ram_40397f4a(int *param_1,int param_2,uint param_3,uint param_4)

{
  ...
  for (iVar2 = 0; iVar2 < (int)(uVar4 >> 2); iVar2 = iVar2 + 1) {
    ...
    FUN_ram_40399daa(auStack_34,param_2,uVar3);
    puVar1[iVar2 + 0x16] = auStack_34[0];
    param_4 = param_4 - uVar3;
    param_2 = param_2 + uVar3;
  }
  *puVar1 = *puVar1 | 0x2000000;
                    /* WARNING: Could not recover jumptable at 0x40397fcc. Too many branches */
