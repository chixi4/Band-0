...
undefined4 FUN_ram_420405be(undefined4 param_1,int param_2,int param_3,int param_4)

{
  ...
  if (((0xe < (uint)(param_4 - param_3)) &&
      (iVar1 = FUN_ram_40399d6c(param_3 + 1,0x3c072e3c,3), iVar1 == 0)) &&
     (((*(byte *)(param_2 + 1) & 8) == 0 ||
      (iVar1 = FUN_ram_40399d6c(0x3fcb4f38,param_3 + 4,4), iVar1 != 0)))) {
    FUN_ram_40399daa(0x3fcb4f38,param_3 + 4,4);
    cVar2 = '\0';
    uVar5 = 0;
    ...
    do {
      ...
      iVar1 = FUN_ram_40399d6c(pcVar3 + 2,0x3fcb0a08,3);
      if (iVar1 != 0) {
        return 0x306a;
      }
      if (pcVar3[5] != '\x04') {
    ...
    if (iVar1 != 0) {
      do {
        iVar1 = FUN_ram_40399daa(iVar1,param_4 + 7,*(byte *)(param_4 + 1) - 5);
        cVar2 = cVar2 + -1;
      ...
      if (_DAT_ram_3fcb4f34 != (code *)0x0) {
        (*_DAT_ram_3fcb4f34)(&iStack_3c,iVar1 - uVar5,uVar5);
      }
