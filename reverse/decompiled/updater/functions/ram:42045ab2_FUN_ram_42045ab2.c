...
void FUN_ram_42045ab2(undefined4 param_1,int param_2,undefined4 param_3,undefined4 param_4,
...

{
  ...
  if ((*(char *)(*(int *)(gp + -0x2b8) + 0x415) != '\0') &&
    ...
    if (iVar5 == 1) {
LAB_ram_42045b12:
                    /* WARNING: Could not recover jumptable at 0x42045b2e. Too many branches */
    ...
    if (iVar5 == 2) {
      ...
      *(undefined1 *)((int)puVar3 + 0x56) = *(undefined1 *)(iVar4 + 0xe);
      if (*(int *)(param_2 + 0x3c) == 0) {
        if (cVar1 != 'Q') {
          _DAT_ram_3fcb5344 = _DAT_ram_3fcb5344 | 4;
        }
      }
      else if (cVar1 != 'Q') goto LAB_ram_42045b12;
    }
    else {
  ...
  *(undefined1 *)(puVar3 + 0xd) = uVar2;
  FUN_ram_420455e8(puVar3,param_1,param_2,param_3,param_4,param_5);
  (**(code **)(_DAT_ram_3fcdfdd8 + 0x54))(_DAT_ram_3fcdfdb4);
  *puVar3 = 0;
  *_DAT_ram_3fcb509c = puVar3;
  _DAT_ram_3fcb5348 = _DAT_ram_3fcb5348 + 1;
  _DAT_ram_3fcb509c = puVar3;
                    /* WARNING: Could not recover jumptable at 0x42045bda. Too many branches */
                    /* WARNING: Treating indirect jump as call */
