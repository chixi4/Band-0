...
void FUN_ram_42021f94(byte *param_1,int param_2,undefined4 param_3,int param_4,undefined4 param_5,
                     undefined4 param_6)

{
  ...
  FUN_ram_40399daa(&uStack_f4,param_3,param_4);
  ...
  FUN_ram_4202a812();
  FUN_ram_42021f5c(abStack_134,auStack_74);
  uStack_60 = 0x80;
  (*(code *)&SUB_ram_40010488)(auStack_5f,0,0x29);
  uStack_36 = 0xa002;
  FUN_ram_42021f5c(abStack_b4,&uStack_f4);
  FUN_ram_40399daa(auStack_34,&uStack_f4,0x14);
  uStack_e0 = 0x80;
  ...
  FUN_ram_4202a824();
  FUN_ram_40399daa(param_6,auStack_34,0x14);
  return;
}
