...
undefined4 FUN_ram_40392698(int param_1,uint *param_2)
...
LAB_ram_403927a2:
    ...
    if (uVar6 != 0) goto LAB_ram_403927a2;
    if (uVar5 != 0) goto LAB_ram_40392756;
  }
  if (bVar3) {
    return 0x102;
  }
LAB_ram_40392756:
  ...
  if ((uVar6 <= uVar7) && (param_2[5] <= uVar7)) {
    iVar9 = FUN_ram_4039385e(param_2[8]);
    if (((iVar9 != 0) || (iVar9 = FUN_ram_4039385e(param_2[9]), iVar9 != 0)) &&
       (iVar9 = FUN_ram_403917a6(), iVar9 == 0)) {
      return 0x103;
    }
    return 0;
  }
