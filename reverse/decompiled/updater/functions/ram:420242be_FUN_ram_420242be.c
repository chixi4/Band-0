...
undefined4
FUN_ram_420242be(int param_1,uint param_2,uint param_3,undefined4 param_4,byte *param_5,
                byte *param_6)

{
  ...
  if (param_2 < 2) {
    ...
    if (param_3 - 0x10 < 0xfffff1) {
      FUN_ram_42023630(param_1 + 0x118,param_4,&local_70);
      iVar10 = (param_3 >> 4) - 1;
      pbVar17 = local_50;
      puVar16 = &local_60;
      iVar15 = iVar10;
      ...
      do {
        ...
        if (param_2 == 0) {
          ...
          FUN_ram_42023630(param_1,pbVar17,pbVar17);
          pbVar13 = pbVar17;
        }
        do {
          uVar14 = *puVar20;
      ...
      if (uVar7 != 0) {
        ...
        FUN_ram_40399e7e(param_6 + iVar10 + 0x10,pbVar19,uVar7);
        ...
        if (param_2 == 0) {
          FUN_ram_42023bea(param_1,pbVar17,pbVar17);
        }
        else {
          FUN_ram_42023630();
        }
