...
undefined4 FUN_ram_4039766e(int param_1,uint param_2,int param_3,int param_4,uint param_5)
...
LAB_ram_4039780c:
    ...
    if ((param_5 & 0xffff) >> 2 == 0) {
      if (uVar7 != 2) goto LAB_ram_4039778a;
      uStack_18 = uStack_18 | 0x4000;
      goto LAB_ram_4039780c;
    }
    if (uVar7 == 4) {
      ...
      if (uVar7 != 5) {
        ...
        for (iVar5 = 0; iVar5 < (int)(uVar9 >> 2); iVar5 = iVar5 + 1) {
          ...
          FUN_ram_40399daa(auStack_54,iVar10,uVar8);
        ...
        *puVar2 = *puVar2 | 0x1000000;
        ...
        if (*(char *)(iVar6 + 2) != '\0') {
          FUN_ram_4039750e(puVar2,*(undefined4 *)(iVar6 + 0xc));
        }
        return 0;
      }
