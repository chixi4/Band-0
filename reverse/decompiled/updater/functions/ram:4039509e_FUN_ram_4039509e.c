...
void FUN_ram_4039509e(int *param_1)

{
  ...
  do {
    *(uint *)(*param_1 + 0x6c) = *(uint *)(*param_1 + 0x6c) | 1;
    ...
    iVar2 = iVar4 - _DAT_ram_3fcb661c;
    if (iVar4 != _DAT_ram_3fcb661c) {
      bVar1 = _DAT_ram_3fcb661c == 0;
      iVar3 = iVar2;
      _DAT_ram_3fcb661c = iVar4;
      if (bVar1) {
        iVar3 = 1;
        _DAT_ram_3fcb661c = iVar2;
      }
      do {
        iVar3 = iVar3 + -1;
        FUN_ram_4039506e();
