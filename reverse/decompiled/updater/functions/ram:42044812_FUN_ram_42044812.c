...
undefined4 FUN_ram_42044812(int param_1,int param_2,int param_3)

{
  ...
  if (iVar3 == 0) {
    FUN_ram_42033fd8(1,0x4000,1,0x3c07dc9c);
    return 0x101;
  }
  if (param_1 == 0) {
    FUN_ram_42033fd8(1,0x800,1,0x3c07dcb8,0x3c072f10,0x19f);
    do {
  ...
  *(undefined1 *)(param_1 + 0x180) = 0x21;
  if (param_3 == 4) {
    *(undefined1 *)(param_1 + 0x17d) = 1;
    ...
    FUN_ram_40399daa(iVar3,0x3c078fbc,0xd4);
    uVar2 = 0xf;
    goto LAB_ram_420448e4;
  }
  if (param_2 == 2) {
    FUN_ram_40399daa(iVar3,gp + -0x48);
    uVar2 = 0xff0;
  }
  else {
    FUN_ram_40399daa(iVar3,0x3c079090,0xd4);
    uVar2 = 0xfff;
  }
LAB_ram_420448e4:
