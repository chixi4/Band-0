...
int FUN_ram_42056228(int param_1,undefined4 *param_2,uint param_3,undefined2 *param_4)

{
  ...
  if (((param_1 == 0) || (param_2 == (undefined4 *)0x0)) ||
     (iVar6 = FUN_ram_42051d86(0x36,0x135,0x280), iVar6 == 0)) {
    iVar6 = 0;
  }
  else {
    if ((param_3 != 3) || (*(char *)((int)param_2 + 5) == '\x03')) {
      if (*(char *)((int)param_2 + 6) == '\0') {
        _DAT_ram_3fcb6808 = FUN_ram_40391b64();
      }
      *param_2 = _DAT_ram_3fcb6808;
    }
    ...
    *puVar2 = 1;
    ...
    uVar3 = FUN_ram_4205074c(*param_2);
