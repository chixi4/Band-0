...
undefined4
FUN_ram_4206295e(undefined4 param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,
...
LAB_ram_42062a36:
    ...
    if (uVar1 == (uVar4 & 0xffffffe0)) {
      iVar3 = FUN_ram_42021b5c(param_1,param_2,4,&psStack_70,&uStack_60,auStack_50);
      if (iVar3 < 0) {
        return 0xffffffff;
      }
      FUN_ram_40399daa(param_6 + uVar1,auStack_50,uVar4 - uVar1);
      goto LAB_ram_42062a36;
    }
    iVar3 = FUN_ram_42021b5c(param_1,param_2,4,&psStack_70,&uStack_60,param_6 + uVar1);
    if (iVar3 < 0) {
      return 0xffffffff;
    }
    sVar5 = sVar5 + 1;
