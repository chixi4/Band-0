...
undefined4 FUN_ram_4204a2c4(void)

{
  ...
  cVar2 = '\0';
  while ((iVar4 = FUN_ram_4204b2c2(cVar2), iVar4 == 0 || (iVar4 = FUN_ram_4204a276(), iVar4 == 0)))
  {
    ...
    if (cVar2 == '\x05') {
      ...
      while( true ) {
        ...
        for (uVar7 = puVar1[uVar5 * 0xc + 8]; uVar7 != 0; uVar7 = *(uint *)(uVar7 + 0x20)) {
          iVar4 = FUN_ram_4204a276(uVar7);
          if (iVar4 != 0) {
            return 1;
          }
        }
        if ((puVar1[(uVar5 + 1) * 0xc + 1] != 0) && (iVar4 = FUN_ram_4204a276(), iVar4 != 0)) break;
