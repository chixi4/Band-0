...
int FUN_ram_420404b8(undefined4 param_1,undefined4 param_2,undefined4 param_3,uint param_4,
                    int param_5)

{
  ...
  if (iVar4 != 0) {
    ...
    *(short *)(iVar4 + 0x16) = (short)iVar5;
    ...
    uVar3 = FUN_ram_42040454(iVar5,0);
    sVar2 = FUN_ram_420352d2(uVar3,param_3,param_4);
