...
undefined4 FUN_ram_4206f9b6(int *param_1)

{
  ...
  if (((uVar2 < 0xb) && ((0x69eU >> (uVar2 & 0x1f) & 1) != 0)) &&
     ((*(char *)(*param_1 + 8) != '\0' || (*(char *)(iVar3 + 0x164) != '\0')))) {
    ...
    *(undefined1 *)param_1[0x2a] = 0xb;
    ...
    uVar1 = FUN_ram_4206e01e(param_1,1);
    return uVar1;
  }
  param_1[1] = param_1[1] + 1;
  return 0;
