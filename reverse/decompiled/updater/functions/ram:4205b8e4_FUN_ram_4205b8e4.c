...
undefined4 FUN_ram_4205b8e4(int param_1,undefined4 param_2,int param_3)

{
  ...
  if (*(int *)(iVar5 + 0x14) == 0) {
    if ((*(uint *)(iVar1 + 0x80) < 6) && ((*(byte *)(iVar1 + 0xdc) & 1) != 0)) {
      iVar2 = thunk_FUN_ram_4039050c(*(undefined4 *)(iVar5 + 0xc),*(int *)(iVar5 + 0x10) + param_3);
      *(int *)(iVar5 + 0xc) = iVar2;
      if (iVar2 == 0) {
        return 0xffffffff;
      }
      FUN_ram_40399daa(*(int *)(iVar5 + 0x10) + iVar2,param_2,param_3);
