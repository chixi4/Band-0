...
void FUN_ram_40391fc6(uint *param_1,int param_2)

{
  ...
  if ((uint *)*puVar1 == (uint *)0x0) {
    ...
    *puVar1 = (uint)param_1;
    ...
    if (param_2 == 0) {
LAB_ram_40391fec:
      FUN_ram_4039123a(*param_1,param_1[1]);
      return;
    }
  }
  else {
...
LAB_ram_4039201a:
    if ((param_2 == 0) && (param_1 == *(uint **)(iVar4 + 0x3fcb6724))) goto LAB_ram_40391fec;
  }
  return;
}
