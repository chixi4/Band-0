...
void FUN_ram_4203f87a(int param_1,int *param_2)

{
  ...
  if (param_2 != (int *)0x0) {
    if (*param_2 != 0) {
      ...
      bVar2 = !bVar2;
      uVar3 = FUN_ram_42044768(param_2);
      ...
      uStack_34 = uVar4;
      uStack_30 = uVar3;
      FUN_ram_42049dee(&uStack_3c);
      if (bVar2) {
        (**(code **)(_DAT_ram_3fcdfdd8 + 0x54))(_DAT_ram_3fcdfdb4);
        if (param_1 == 0) {
          if (DAT_ram_3fcb5116 != '\0') {
            DAT_ram_3fcb5116 = DAT_ram_3fcb5116 + -1;
          }
        }
        else {
          DAT_ram_3fcb5116 = DAT_ram_3fcb5116 + '\x01';
        }
