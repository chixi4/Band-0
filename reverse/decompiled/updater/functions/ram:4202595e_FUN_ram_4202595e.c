...
undefined4 FUN_ram_4202595e(int *param_1,int *param_2,int *param_3,int *param_4)

{
  ...
  uStack_2c = 0;
  iVar3 = FUN_ram_42024dea(param_3,0);
  uVar9 = 0xfffffffc;
  if (-1 < iVar3) {
    iVar3 = FUN_ram_42024d4a(param_3,param_4);
    uVar9 = 0xfffffffc;
    if ((((iVar3 < 1) && (iVar3 = FUN_ram_42024ae6(param_4,0), iVar3 == 1)) &&
        ((piVar2 = param_3, param_2 == (int *)0x0 ||
         (((iVar3 = FUN_ram_42024dea(param_4,1), iVar3 != 0 &&
      ...
      iVar3 = FUN_ram_4202479e(param_1,*(undefined2 *)((int)param_4 + 6));
      if (((iVar3 == 0) &&
          ((param_2 == (int *)0x0 ||
           (iVar3 = FUN_ram_4202479e(param_2,*(undefined2 *)((int)param_4 + 6)), iVar3 == 0)))) &&
         (iVar3 = FUN_ram_4202939a((uint)*(ushort *)((int)param_4 + 6) << 2,
        ...
        FUN_ram_42026d48(*param_1,iVar5,puVar6,uVar7,*param_4,uVar1,iVar3);
