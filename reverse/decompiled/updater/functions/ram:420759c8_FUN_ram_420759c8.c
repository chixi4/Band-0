...
void FUN_ram_420759c8(undefined4 param_1,undefined4 param_2,int param_3,int param_4,int param_5,
...

{
  ...
  iVar1 = 0;
  do {
    iVar2 = FUN_ram_42075314(param_2,param_1);
    iVar5 = ((*(char *)(param_3 + iVar1) - param_4) + param_5) * 0x10000 >> 0x10;
    (**(code **)(_DAT_ram_3fcb640c + 0x1d0))
    ...
    *(char *)(param_9 + iVar1) = (char)sVar4;
    if (param_12 != '\0') {
      FUN_ram_42076e98(0x3fcb112c,iVar1,*(undefined1 *)(param_11 + iVar1),*puVar3,(int)sVar4,
