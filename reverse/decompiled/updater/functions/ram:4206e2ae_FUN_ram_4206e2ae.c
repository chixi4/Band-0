...
int FUN_ram_4206e2ae(undefined4 *param_1,int param_2)
      ...
      while( true ) {
        ...
        if (param_1[3] == 0) {
          if (uVar3 < (uint)param_1[0x1e]) {
            ...
            FUN_ram_40399e7e(param_1[0x1b],uVar3 + param_1[0x1b]);
            uVar5 = param_1[0x1e];
...
LAB_ram_4206e32c:
        if (param_1[0x1e] == 0) goto LAB_ram_4206e378;
LAB_ram_4206e330:
        iVar2 = FUN_ram_4206e1fc(param_1);
        if ((iVar2 + 0x6680U & 0xfffffeff) != 0) {
          if (iVar2 != 0) {
            return iVar2;
          }
          if ((param_1[0x1d] == 0x16) && (param_2 == 1)) {
            iVar2 = FUN_ram_4206ddfa(param_1);
            return iVar2;
          }
          goto LAB_ram_4206e4fc;
        }
      }
      if (param_1[0x1c] != 0) goto LAB_ram_4206e32c;
      param_1[0x1e] = 0;
LAB_ram_4206e378:
      iVar2 = FUN_ram_4206dd40(param_1,5);
      if (iVar2 == 0) {
        ...
        FUN_ram_40399daa(auStack_4c,param_1[0x17],8);
        iStack_38 = 5;
        ...
        pbStack_40 = pbVar6;
        iVar2 = FUN_ram_4206dd40(param_1);
        if (iVar2 == 0) {
          param_1[0x1f] = 0;
          if (param_1[0xf] != 0) {
            iVar2 = FUN_ram_4206d8e8(param_1,param_1[0xf],auStack_4c);
            if (iVar2 != 0) {
              if (iVar2 == -0x7180) {
LAB_ram_4206e456:
                FUN_ram_4206e0e0(param_1,2,0x14);
                return -0x7180;
              }
              goto LAB_ram_4206e4f2;
            }
            if (uStack_34 == 0) {
              ...
              if (3 < iVar2 + 1) goto LAB_ram_4206e456;
            }
            else {
              param_1[0x21] = 0;
            }
