...
/* WARNING: Removing unreachable block (ram,0x42012224) */
/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_ram_42011ec8(uint param_1)

{
  ...
  FUN_ram_40393a94(0x6d,0,0xd,3,3,0);
  FUN_ram_40393a94(0x6d,0,0xd,2,2,0);
  _DAT_ram_6000801c =
       (param_1 & 0xff) << 6 | (param_1 >> 0x10) << 0x18 | _DAT_ram_6000801c & 0xffc03f;
  _DAT_ram_60008028 = _DAT_ram_60008028 & 0xffff00ff | 0x200;
  if (-1 < (int)(param_1 << 1)) goto LAB_ram_42011fc0;
  uVar5 = _DAT_ram_60008844 >> 0x19 & 7;
  if ((_DAT_ram_60008844 >> 0x1c & 3) == 0) goto LAB_ram_42011f70;
  if ((_DAT_ram_60008830 >> 0x1c & 1) != 0) goto LAB_ram_42011f74;
  do {
    FUN_ram_40399b58();
    uVar5 = extraout_a5;
LAB_ram_42011f70:
    if (uVar5 == 0) {
      iVar2 = FUN_ram_40393c62();
      uVar1 = 2;
      if (iVar2 != 1) {
        uVar1 = iVar2 == 2;
      }
      uVar3 = FUN_ram_40394308(uVar1,100);
      lVar6 = FUN_ram_403943dc(10000,0,uVar3);
      lVar7 = FUN_ram_40394466();
      FUN_ram_40393d4c(auStack_30);
      FUN_ram_40394002();
      FUN_ram_40393a94(0x61,0,0,0,0,0);
      FUN_ram_40393a94(0x61,0,0,0,0,1);
      do {
        iVar2 = FUN_ram_40393a22(0x61,0,3,0,0);
        iVar4 = FUN_ram_40393a22(0x61,0,3,3);
        uVar8 = FUN_ram_40394466();
...
LAB_ram_42011f74:
      ...
      FUN_ram_40393a94(0x61,0,6,7,0,uVar5 + 100 & 0xff);
      FUN_ram_40393a94(0x61,0,5,6,6,1);
    }
LAB_ram_42011fc0:
    if ((_DAT_ram_60008844 >> 0x1c & 3) == 0) {
      if ((_DAT_ram_60008844 >> 0x19 & 7) == 0) goto LAB_ram_42012238;
      goto LAB_ram_42011fd8;
    }
...
LAB_ram_42012238:
        ...
        uVar1 = FUN_ram_42011d60(1,uVar5);
      }
      FUN_ram_40393a94(0x6d,0,4,4,0,uVar1);
      FUN_ram_40393a94(0x6d,0,6,4,0,uVar5);
      if ((int)(param_1 << 7) < 0) {
      ...
      FUN_ram_40393a94(0x61,0,0,2,2,1);
      _DAT_ram_60008108 = _DAT_ram_60008108 & 0x3fffffff;
      return;
    }
  } while( true );
}
