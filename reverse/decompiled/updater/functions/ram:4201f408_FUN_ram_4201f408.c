...
bool FUN_ram_4201f408(int param_1,int param_2)
...
LAB_ram_4201f4dc:
        ...
        if ((1 << (uVar2 - 4 & 0x1f) & 0x116011U) != 0) goto LAB_ram_4201f4dc;
        if (uVar3 == 0x1d) goto LAB_ram_4201f456;
      }
    }
    else if (uVar2 == 0x48) {
