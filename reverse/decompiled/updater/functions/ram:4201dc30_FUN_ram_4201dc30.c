...
void FUN_ram_4201dc30(int param_1,int *param_2)

{
  ...
  do {
        ...
        if ((piVar6[8] == piVar6[7]) && (piVar6[9] == (uint)*(byte *)((int)piVar6 + 0x19))) {
          ...
          while ((iVar5 != 0 &&
                 ((((iVar4 = *(int *)(iVar5 + 0xc), iVar4 == -0x10 || (iVar4 == 0)) || (iVar4 == -1)
                   ) || (iVar4 = FUN_ram_420203ca(iVar5,(char)piVar6[6],0x48,piVar6 + 2,0xff,
    ...
    iStack_e4 = 0;
    while (iVar4 = FUN_ram_42020034(iVar5,0xff,0x42,0,&iStack_e4,auStack_e0,0xff), iVar4 == 0) {
      iVar4 = *param_2;
      FUN_ram_40399daa(auStack_c0,auStack_e0,0x20);
      ...
      for (; iVar4 != 0; iVar4 = *(int *)(iVar4 + 4)) {
        iVar3 = FUN_ram_4039a1de(auStack_38,iVar4 + 8,0xf);
