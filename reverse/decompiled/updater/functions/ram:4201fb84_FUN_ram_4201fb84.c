...
int FUN_ram_4201fb84(int param_1,uint param_2,uint param_3,undefined4 param_4)

{
  ...
  if (param_2 < param_3) {
    ...
    for (; (int)param_2 <= (int)param_3; param_3 = param_3 - 1) {
      iVar2 = FUN_ram_4201f9bc(param_1 + 0x18,param_3,param_4);
      if (iVar2 != 0) goto LAB_ram_4201fb90;
      uVar4 = 0xffffffff;
      if (param_2 != param_3) {
        uVar4 = param_3 - 1 >> 4;
      }
