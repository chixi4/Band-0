...
uint FUN_ram_42031f60(int *param_1,int param_2)

{
  ...
  if (((sVar3 == -0x7178) || (sVar3 == -0x4b78)) ||
     ((*param_1 == _DAT_ram_3fcb4f84 && (sVar3 == 0x608)))) {
LAB_ram_42031fb6:
    thunk_FUN_ram_4204bd80(param_2,1);
  }
  else {
    if (sVar3 == 8) {
      pbVar6 = pbVar4 + 0x16;
      if ((uVar7 == 0) && (pbVar6 = pbVar4 + 0xe, pbVar4[0x17] == 0x11)) {
        ...
        {
          FUN_ram_42033fd8(1,0x40,4,0x3c07ab54);
          goto LAB_ram_42031fb6;
        }
      }
    ...
    if (((*pbVar4 & 1) == 0) && ((param_1[3] & 2U) != 0)) goto LAB_ram_4203204a;
  }
  uVar5 = 7;
LAB_ram_4203204a:
  abStack_18[0] = 1;
