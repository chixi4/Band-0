...
int FUN_ram_4202802c(int *param_1,int param_2)
  ...
  if (param_1 == (int *)0x0) {
    ...
    if (*param_1 != 0) {
      ...
      if ((iVar2 != 0) && (iVar1 = -0x6100, param_2 != 0)) {
        ...
        FUN_ram_420293a6(local_60,0x10);
        FUN_ram_420293a6(local_50,0x10);
        FUN_ram_42027e46(param_1,local_60,local_50);
        ...
        iVar1 = FUN_ram_420274c2(param_1,iVar2,uVar8,iVar2,auStack_64);
        if (iVar1 == 0) {
          FUN_ram_40399daa(param_2,iVar2,uVar8);
        }
        FUN_ram_420293a6(local_60,0x10);
        FUN_ram_420293a6(local_50,0x10);
        *(undefined4 *)(iVar2 + 0x20) = 0;
        FUN_ram_420293a6(iVar2 + 0x10,0x10);
