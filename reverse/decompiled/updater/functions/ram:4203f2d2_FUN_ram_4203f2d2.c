...
void FUN_ram_4203f2d2(int *param_1,int param_2,int param_3)
...
LAB_ram_4203f35e:
        ...
        goto LAB_ram_4203f35e;
      }
      FUN_ram_40399daa(param_1[0xce],*(int *)(param_2 + 0x68),
                       *(byte *)(*(int *)(param_2 + 0x68) + 1) + 2);
    }
    iVar5 = *(int *)(param_2 + 0x3c);
    if ((iVar5 == 0) || (0x3e < *(byte *)(iVar5 + 1))) {
      if ((DAT_ram_3fcb512d != '\x0f') || (iVar5 != 0)) {
      ...
      *(byte *)((int)param_1 + 0x33d) = *(byte *)(iVar5 + 1) + 2;
      FUN_ram_40399daa((int)param_1 + 0x33e,iVar5,*(byte *)(iVar5 + 1) + 2);
    }
    ...
    if ((iVar5 == 0) || (0x3e < *(byte *)(iVar5 + 1))) {
      ...
      *(byte *)(param_1 + 0xc) = *(byte *)(iVar5 + 1) + 2;
      FUN_ram_40399daa((int)param_1 + 0x33,iVar5,*(byte *)(iVar5 + 1) + 2);
    }
    sVar3 = _DAT_ram_3fcb5134;
    uVar2 = DAT_ram_3fcb512e;
    *(short *)(param_1 + 0xa9) = _DAT_ram_3fcb5134;
    *(bool *)((int)param_1 + 0x2f9) = sVar3 != 0;
    cVar4 = DAT_ram_3fcb51c0;
    *(undefined1 *)((int)param_1 + 0x29e) = uVar2;
    *(bool *)((int)param_1 + 0x37e) = cVar4 != '\0';
    *(bool *)((int)param_1 + 0x37f) = DAT_ram_3fcb51c1 != '\0';
    *(undefined2 *)(param_1 + 0xa7) = _DAT_ram_3fcb512c;
    *(undefined1 *)(param_1 + 0xa8) = DAT_ram_3fcb5130;
    *(undefined1 *)((int)param_1 + 0x2a6) = DAT_ram_3fcb5136;
  }
  ...
  *(undefined2 *)(param_1 + 0xb) = *(undefined2 *)(param_2 + 8);
  FUN_ram_40399daa(param_1 + 6,uVar6,8);
  if ((((*(ushort *)((int)param_1 + 0x2a) ^ *(ushort *)(param_2 + 6)) & 0x400) != 0) &&
     (piVar1 == param_1)) {
    FUN_ram_42043106(&DAT_ram_3fcb4f74,*(ushort *)(param_2 + 6) & 0x400);
  }
  *(undefined2 *)((int)param_1 + 0x2a) = *(undefined2 *)(param_2 + 6);
  if (((*(uint *)(*param_1 + 0xa4) & 0x2000) == 0) || (*(int *)(param_2 + 0x40) == 0)) {
    ...
    iVar5 = FUN_ram_420409fc(param_1);
  ...
  if ((*(int *)(param_2 + 0x44) != 0) && (*(int *)(param_2 + 0x48) != 0)) {
    if ((*(uint *)(*param_1 + 300) & 0x80000) != 0) {
      FUN_ram_42036eba(param_1);
      goto LAB_ram_4203f4f0;
    }
  }
...
LAB_ram_4203f4f0:
  FUN_ram_420433a2(param_1,*(undefined4 *)(param_2 + 0x20));
  (*(code *)&SUB_ram_4001214c)(param_1);
  if (((_DAT_ram_3fcb516c & 1) != 0) && (*(int *)(param_2 + 0x58) != 0)) {
    FUN_ram_42040c8e(param_1);
    return;
  }
  return;
}
