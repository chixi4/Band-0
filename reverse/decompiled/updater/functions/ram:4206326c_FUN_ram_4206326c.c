...
undefined4
FUN_ram_4206326c(int param_1,undefined4 param_2,undefined4 param_3,undefined4 param_4,char *param_5,
...

{
  ...
  if (((((((*param_5 != '\0' || param_5[1] != '\0') || param_5[2] != '\0') || param_5[3] != '\0') ||
     ...
     ((param_9 == 0 ||
      (iVar2 = FUN_ram_4206236e(param_2,param_3,*(undefined4 *)(param_1 + 0x1f0),param_4,param_7,
                                param_8), iVar2 == 0)))) {
    uVar1 = FUN_ram_420661fa(param_1,param_5,param_6,param_7,param_8);
    return uVar1;
  }
  return 0xffffffff;
}
