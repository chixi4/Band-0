...
undefined4 FUN_ram_42043252(int param_1,int param_2)
    ...
    if ((iVar4 != 1) || (uVar7 < 2)) {
      ...
      if (cStack_39 != '\0') {
        if (((*(int *)(iVar8 + 0x40c) == 0) && ((*(int *)(iVar2 + 0x98) - 3U & 0xfffffffd) == 0)) &&
           (iVar4 = FUN_ram_40399d6c(iVar8 + 0x404,&uStack_3c,0xc), iVar4 != 0)) {
          FUN_ram_4204321e();
          DAT_ram_3fcb5144 = 1;
        }
        iVar4 = FUN_ram_40399d6c(param_1,&uStack_3c,0xc);
        if (iVar4 != 0) {
          FUN_ram_40399daa(param_1,&uStack_3c,0xc);
          DAT_ram_3fcb5144 = 1;
