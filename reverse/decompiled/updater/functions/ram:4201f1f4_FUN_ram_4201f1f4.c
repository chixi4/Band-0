...
int FUN_ram_4201f1f4(int param_1,undefined4 param_2)

{
  ...
  uVar1 = FUN_ram_4201977c();
  iVar2 = FUN_ram_4201efea(param_1,param_2);
  if (iVar2 == 0) {
    if (uVar1 == 0) {
      return -1;
    }
    apiStack_24[0] = (int *)0x0;
    iVar2 = FUN_ram_42020c88(param_2,apiStack_24);
    if (iVar2 == 0) {
      uVar3 = (**(code **)(*apiStack_24[0] + 0x24))();
      iVar2 = FUN_ram_4201f106(param_1,apiStack_24[0],0,uVar3 / uVar1);
      if (iVar2 == 0) {
