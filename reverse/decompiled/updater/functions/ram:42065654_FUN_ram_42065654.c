...
undefined4 FUN_ram_42065654(char *param_1,int param_2,undefined4 *param_3)

{
  ...
  do {
    ...
    if (cVar1 == '0') {
      ...
      if ((((uVar2 < 6) || (iVar3 = FUN_ram_420652bc(param_1 + 2), iVar3 != 0x50f201)) ||
          (param_1[6] != '\x01')) || (param_1[7] != '\0')) {
        if ((param_1 + 5 < pcVar5) && (0x13 < uVar2)) {
          iVar3 = FUN_ram_420652bc(param_1 + 2);
          if (iVar3 == 0xfac04) {
            param_3[4] = param_1 + 6;
          }
          else {
LAB_ram_42065762:
            ...
            if (iVar3 == 0xfac01) {
              ...
              if (iVar3 != 0xfac09) goto LAB_ram_420657d0;
              param_3[9] = param_1 + 6;
          ...
          if (6 < uVar2) goto LAB_ram_42065762;
          if (uVar2 < 5) goto LAB_ram_420656d2;
LAB_ram_420657d0:
          iVar3 = FUN_ram_420652bc(param_1 + 2);
          if (iVar3 == 0x506f9a20) {
