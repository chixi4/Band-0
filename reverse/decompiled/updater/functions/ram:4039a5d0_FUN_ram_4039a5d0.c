...
int FUN_ram_4039a5d0(int param_1)

{
  ...
  *(undefined1 *)(iVar10 + 0x2f) = *(undefined1 *)(param_1 + 0x1b);
  ...
  while( true ) {
    ...
    if (puVar16 == (undefined1 *)0x0) goto LAB_ram_4039a71c;
...
LAB_ram_4039a71c:
  if ((**(uint **)(param_1 + 0x24) & 0x400000) == 0) {
    ...
    if (iVar10 != iVar2) {
      FUN_ram_42033fd8(6,0x800,1,0x3c07de24,0x3c072f44,0xc03);
      do {
  ...
  FUN_ram_4207895a(param_1,puVar14,iVar2 - iVar13 & 0xffff);
  *(int *)(_DAT_ram_3fcdfdec + (uVar11 + 1) * 0x30 + 4) = param_1;
  FUN_ram_420786a6(uVar11);
  return param_1;
}
