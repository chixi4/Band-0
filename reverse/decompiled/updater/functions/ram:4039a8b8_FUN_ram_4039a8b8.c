...
undefined4 FUN_ram_4039a8b8(undefined4 param_1)
  ...
  if (iVar2 == 0) {
    ...
    if (iVar2 != 0) {
      ...
      if ((**(uint **)(iVar2 + 0x24) & 0x40000) == 0) {
        if ((iVar4 != 0) && ((*(char *)(iVar4 + 0x83) == '\x01' || (DAT_ram_3fcb55b2 != '\0')))) {
          if ((*(ushort *)(gp + 0x5c8) < *(ushort *)(iVar2 + 0x16)) &&
             ((((**(uint **)(iVar2 + 0x24) & 2) == 0 &&
               (iVar4 = (*(code *)&SUB_ram_40011c10)(param_1), iVar4 != 0)) &&
              (iVar4 = FUN_ram_4204a494(iVar2), iVar4 == 0)))) {
            (*(code *)&SUB_ram_40011c14)(param_1);
              ...
              ((iVar4 = (*(code *)&SUB_ram_40011cd0)
               ...
               (iVar4 = FUN_ram_4039a5d0(iVar2), iVar4 == 0)))) {
      ...
      FUN_ram_4039a2c8(iVar2);
      FUN_ram_4039ab44(iVar2,param_1);
      uVar3 = 0;
    }
  }
  return uVar3;
