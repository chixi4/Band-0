...
int FUN_ram_4203d352(int *param_1,int param_2)

{
  ...
  if ((param_1 != (int *)0x0) && (*param_1 != 0)) {
    ...
    if (param_2 == 0) {
      ...
      if (iVar1 != 0) {
        FUN_ram_40399daa(iVar1,param_1,0xc);
        if ((param_1[2] != 0) && (param_1[1] != 0)) {
          ...
          *(int *)(iVar1 + 4) = iVar3;
          ...
          FUN_ram_40399daa(iVar3,param_1[1],param_1[2]);
        }
        ...
        if (puVar2 == (undefined1 *)0x0) {
          ...
          *puVar2 = 0x31;
          *(undefined4 *)(puVar2 + 4) = 0x4202b4e6;
          *(undefined2 *)(puVar2 + 8) = 2;
          puVar2[10] = 0;
          *(int *)(puVar2 + 0xc) = iVar1;
          *(undefined4 *)(puVar2 + 0x14) = 0;
          iVar3 = FUN_ram_4203b75a();
          if (iVar3 == 0) {
            return 0;
          }
        }
        FUN_ram_42033fd8(1,2,1,0x3c07d814);
        if ((param_1[2] != 0) && (param_1[1] != 0)) {
