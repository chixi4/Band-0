...
int FUN_ram_420715b4(int *param_1,int *param_2)

{
  ...
  do {
    if (((*param_1 != *param_2) || (param_1[1] != param_2[1])) ||
       (iVar1 = FUN_ram_40399d6c(param_1[2],param_2[2]), iVar1 != 0)) {
      return -1;
    }
    iVar3 = param_1[3];
    iVar1 = param_2[3];
    if (((iVar3 != iVar1) || (param_1[4] != param_2[4])) ||
       (iVar2 = FUN_ram_40399d6c(param_1[5],param_2[5]), iVar2 != 0)) {
      ...
      iVar1 = FUN_ram_42071570(param_1[5],param_2[5]);
      if (iVar1 != 0) {
        return -1;
      }
    }
