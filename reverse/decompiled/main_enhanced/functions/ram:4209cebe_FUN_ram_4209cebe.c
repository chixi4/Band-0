...
undefined4
FUN_ram_4209cebe(undefined4 param_1,undefined4 param_2,uint param_3,int param_4,int param_5,
...

{
  ...
  if ((param_3 < 0x41) &&
     ((((param_10 & 0x30000) == 0 || (param_5 != 0)) &&
      (iVar2 = FUN_ram_4039c08e(1,0x80), iVar2 != 0)))) {
    FUN_ram_4039c11e(iVar2 + 0x14,param_2,param_3);
    *(uint *)(iVar2 + 0x54) = param_3;
    if (param_4 == 0) {
      if ((param_10 != 0x20000) && ((param_10 & 0x30000) == 0)) {
        FUN_ram_4209c6a6(param_2,param_3,param_7,param_8,iVar2 + 4,param_10);
      }
    }
    else {
      FUN_ram_4039c11e(iVar2 + 4,param_4,0x10);
    }
    ...
    *(uint *)(iVar2 + 0x60) = param_10;
    FUN_ram_4039c11e(iVar2 + 100,param_7,6);
    *(undefined4 *)(iVar2 + 0x78) = param_9;
    uVar1 = FUN_ram_4209cd9c(param_1,iVar2);
  }
  else {
    uVar1 = 0;
  }
