...

{
  ...
  iVar5 = _DAT_ram_3fcb6bc8 + 0x110;
  *(undefined2 *)(_DAT_ram_3fcb6bc8 + 0x10e) = 0;
  FUN_ram_4039c11e(auStack_128,iVar5,*piVar1 * 0x58);
  iVar3 = *(int *)(iVar3 + 0x218);
  puVar2 = auStack_128;
  ...
  for (iVar5 = 0; iVar5 < iVar3; iVar5 = iVar5 + 1) {
    ...
    iVar4 = FUN_ram_42033d02(auStack_180);
    puVar6 = puVar6 + 0x58;
    if (iVar4 != 0) {
      return iVar4;
    }
  ...
  while( true ) {
    ...
    iVar4 = FUN_ram_420340cc(auStack_180);
    puVar2 = puVar2 + 0x58;
    if (iVar4 != 0) break;
    iVar5 = iVar5 + 1;
  }
