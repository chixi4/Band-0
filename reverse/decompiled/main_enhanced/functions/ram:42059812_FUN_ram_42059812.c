...
void FUN_ram_42059812(int param_1)

{
  ...
  iVar3 = FUN_ram_420591cc(param_1,iVar2,3,&uStack_22);
  if (iVar3 != 0) {
    iVar11 = *(int *)(iVar3 + 4);
    iVar9 = iVar11 + 0xf0;
    uVar4 = FUN_ram_42058e58(uStack_22,iVar9,0x39,2);
    ...
    uStack_22 = FUN_ram_42059468(uVar10,iVar9,*(undefined4 *)(param_1 + 0x2c));
    FUN_ram_4205c572(param_1,1,iVar11,&uStack_22);
    FUN_ram_42058eee(uStack_22,iVar9,iVar3);
