...
void FUN_ram_420b2624(uint param_1,undefined1 param_2)

{
  ...
  if (4 < param_1) {
    FUN_ram_4207a038(6,0x800,1,&DAT_ram_3c0ff6b8,&DAT_ram_3c0c4a54,&DAT_ram_3c0fac54,0x2ac);
    do {
  ...
  if (*(byte *)((int)piVar3 + 0x1d) < 3) {
    FUN_ram_42094078(piVar3,param_1);
  }
