...
int FUN_ram_4204d3fe(int param_1,int *param_2,int param_3)
    ...
    if (iVar1 == 0) {
      if (local_50 == -1) {
        *(undefined4 *)(param_1 + 0xc) = 0xffffffff;
        piVar2 = (int *)FUN_ram_420abb9c(0x200,&DAT_ram_3c0fb80c);
        if (piVar2 == (int *)0x0) {
          return 0x101;
        }
        iVar6 = 0;
...
LAB_ram_4204d4c2:
              if (piVar2 + 0x80 != piVar4) {
                *(undefined4 *)(param_1 + 0xc) = 0xfffffff0;
                goto LAB_ram_4204d4ca;
              }
              break;
            }
            if (piVar4[1] != -1) {
              piVar4 = piVar4 + 1;
              goto LAB_ram_4204d4c2;
            }
            if (piVar4[2] != -1) {
              piVar4 = piVar4 + 2;
              goto LAB_ram_4204d4c2;
...
LAB_ram_4204d4ca:
        ...
        iVar6 = FUN_ram_4204c478(&local_50);
        if (iStack_34 == iVar6) {
      ...
      if (uVar5 != 0xffffffff) {
        if (((uVar5 & 0xfffffffb) == 0xfffffff8) || (uVar5 == 0xfffffffe)) {
          iVar1 = FUN_ram_4204d0ee(param_1);
        }
        else {
          *(undefined4 *)(param_1 + 0xc) = 0xfffffff0;
        }
