...
int FUN_ram_4039da8e(int param_1)

{
  ...
  if ((_DAT_ram_3fcc4648 != 0) &&
     ((uint)(*(int *)(gp + 0x6f4) << 10) <
      (uint)(_DAT_ram_6004d000 - *(int *)(*(int *)(_DAT_ram_3fcc4648 + 0x24) + 4)))) {
  ...
  _DAT_ram_3fcc4724 = _DAT_ram_3fcc4724 + 1;
  uVar8 = (*(code *)&SUB_ram_40011c58)(pbVar15);
  iVar4 = _DAT_ram_3fcc4648;
  uVar8 = uVar8 & 0xffff;
  if ((bVar1 & 0x40) == 0) {
    if (iVar7 != 0) {
      FUN_ram_4207a038(6,0x20,2,&DAT_ram_3c1022b8);
      goto LAB_ram_4039dc48;
    }
...
LAB_ram_4039dc10:
  ...
  if (_DAT_ram_3fcc4648 == 0) {
    if ((uVar2 & 0xf) == 0) {
LAB_ram_4039dbda:
      _DAT_ram_3fcc4648 = param_1;
      _DAT_ram_3fcc464c = (short)uVar8 + (short)uVar6;
      _DAT_ram_3fcc4650 = uVar5;
      _DAT_ram_3fcc4654 = uVar14;
      return 0;
    }
LAB_ram_4039dc48:
  ...
  iVar18 = *(int *)(*(int *)(_DAT_ram_3fcc4648 + 4) + 4);
  iVar9 = FUN_ram_42092dd0(pbVar15);
  iVar10 = FUN_ram_42092dd0(iVar18);
  if ((iVar9 != iVar10) || (iVar9 = FUN_ram_4039c0e0(pbVar15 + 4,iVar18 + 4,0xc), iVar9 != 0))
  goto LAB_ram_4039dc48;
  if (((*(ushort *)(iVar18 + 0x16) ^ uVar2) & 0xfff0) == 0) {
    uVar13 = *(ushort *)(iVar18 + 0x16) + 1;
    if (uVar2 == uVar13) {
      if ((!bVar3) ||
         ((_DAT_ram_3fcc4650 + 1 == uVar5 &&
          ((_DAT_ram_3fcc4650 + 1 < _DAT_ram_3fcc4650) + _DAT_ram_3fcc4654 == uVar14)))) {
        if (_DAT_ram_3fcc464c + uVar12 < *(int *)(_DAT_ram_3fcdfdec + 0x3b0) - 0x30U) {
          puVar17 = *(uint **)(iVar4 + 0x10);
          FUN_ram_4039c11e((uint)_DAT_ram_3fcc464c + iVar18,pbVar15 + uVar8,uVar12);
          _DAT_ram_3fcc464c = _DAT_ram_3fcc464c + (short)uVar6;
        ...
        *(byte *)(iVar18 + 1) = *(byte *)(iVar18 + 1) & 0xfb;
        ...
        uStack_68 = 0;
        uStack_64 = 0;
        FUN_ram_4039c11e(auStack_70,(_DAT_ram_3fcc464c - 8 & 0xffff) + iVar7,8);
        iVar7 = FUN_ram_420924f6(cVar16,2,0,iVar7 + 10,auStack_60,0x20);
        if (iVar7 != 0) {
          (*(code *)&SUB_ram_40011e60)(auStack_60,iVar4,uVar8,&uStack_68);
          iVar7 = FUN_ram_4039c0e0(&uStack_68,auStack_70,8);
          if (iVar7 == 0) {
            _DAT_ram_3fcc4648 = 0;
            _DAT_ram_3fcc464c = 0;
            _DAT_ram_3fcc4650 = 0;
        ...
        goto LAB_ram_4039ddec;
      }
    }
    else if (uVar2 <= uVar13) goto LAB_ram_4039dc48;
  }
  else if ((uVar2 & 0xf) == 0) {
    (*(code *)&SUB_ram_40011c1c)(iVar4);
    goto LAB_ram_4039dbda;
  }
  (*(code *)&SUB_ram_40011c1c)(param_1);
LAB_ram_4039ddec:
  if (_DAT_ram_3fcc4648 != 0) {
