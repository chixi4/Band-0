...

{
  ...
  if (param_3 != 0) {
    ...
    if (*(ushort *)((int)param_1 + 0x6a) == 0) {
      if ((param_1[0x1d] != 0) || (param_1[0x1c] != 0)) goto LAB_ram_420575f4;
    }
    else if ((param_1[0x1d] == 0) && (param_1[0x1c] == 0)) goto LAB_ram_420575f4;
  }
  ...
  if (piVar9 == (int *)0x0) {
    piVar15 = (int *)0x0;
    uVar4 = 0;
    if ((short)param_1[0x1b] != 0) goto LAB_ram_420575f4;
LAB_ram_42057696:
    piVar3 = piVar9;
    uVar6 = 0;
    piVar9 = (int *)0x0;
...
LAB_ram_42057722:
    ...
    if (uVar11 < (uint)*(ushort *)(piVar15 + 2) + uVar4 * 4) goto LAB_ram_420575f4;
    ...
    if (uVar6 < uVar8) goto LAB_ram_420575f4;
    uVar4 = uVar8;
    if (param_3 < uVar8) {
      uVar4 = param_3;
    }
    ...
    piVar9 = (int *)0x0;
    piVar10 = piVar15;
    if (param_3 != uVar4) goto LAB_ram_420575f4;
  }
  if (uVar4 == 0) {
    *(undefined2 *)(param_1 + 0x1b) = uVar7;
    if (piVar15 != (int *)0x0) goto LAB_ram_42057688;
