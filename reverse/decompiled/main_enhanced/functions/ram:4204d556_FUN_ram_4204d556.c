...
undefined4 FUN_ram_4204d556(int param_1,int *param_2)

{
  ...
  do {
    ...
    iStack_34 = 0;
    while (iVar1 = FUN_ram_4204cd30(iVar3,0xff,0x48,0,&iStack_34,auStack_30,0xff), iVar1 == 0) {
      piVar2 = (int *)thunk_FUN_ram_403904a6(0x28);
      if (piVar2 == (int *)0x0) {
        return 0x101;
      }
      FUN_ram_4039c61e(piVar2 + 2,auStack_28,0x10);
