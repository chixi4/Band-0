...
bool FUN_ram_4207e7c6(int param_1,ushort *param_2,undefined4 param_3,undefined4 param_4)

{
  ...
  bVar2 = false;
  if (DAT_ram_3fcc41d5 == '\0') {
    uStack_26 = 0;
    bStack_28 = 0;
    cStack_27 = '\0';
    auStack_24[0] = 0;
    iVar4 = _DAT_ram_3fcc2a14 + param_1 * 0x34;
    bVar1 = *(byte *)(iVar4 + 0x21);
    if (bVar1 == 2) {
      iVar6 = (**(code **)(_DAT_ram_3fcdfdd8 + 0x120))
                        (*(undefined4 *)(*(int *)(gp + -0xb4) + 0x410),iVar4,&uStack_26,param_4,
                         *(int *)(gp + -0xb4),*(code **)(_DAT_ram_3fcdfdd8 + 0x120));
      ...
      if (2 < bVar1) {
        ...
        iVar5 = (**(code **)(_DAT_ram_3fcdfdd8 + 0x134))
                          (*(undefined4 *)(*(int *)(gp + -0xb4) + 0x410),iVar4,iVar6,auStack_24,
                           *(int *)(gp + -0xb4),*(code **)(_DAT_ram_3fcdfdd8 + 0x134));
        if (iVar5 != 0) {
          FUN_ram_4039c11e(iVar6,iVar4 + 0x2c,auStack_24[0]);
        }
        iVar4 = FUN_ram_4039c0e0(iVar6,param_2,auStack_24[0]);
