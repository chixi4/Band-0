...
undefined4 FUN_ram_4208885e(undefined8 param_1)

{
  ...
  FUN_ram_4207a038(param_1,*(undefined8 *)(unaff_s0 + 0x38),1,4,3,&DAT_ram_3c0ffecc,in_a4 + -0x708,
                   pcVar3,&stack0x00000034,(int)*(char *)(unaff_s1 + 0xa4));
  FUN_ram_42086fc2();
  FUN_ram_420864f8();
