...

{
  *param_1 = *(byte *)((int)param_2 + 3) ^ *param_1;
  ...
  param_1[10] = (byte)((uint)param_2[2] >> 8) ^ param_1[10];
  ...
  param_1[0xe] = (byte)((uint)param_2[3] >> 8) ^ param_1[0xe];
