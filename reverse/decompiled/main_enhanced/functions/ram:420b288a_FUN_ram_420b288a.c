...
void FUN_ram_420b288a(int param_1,int param_2)
  ...
  if (param_1 != 0) {
    if ((((-1 < (char)*(byte *)(param_1 + 0xb)) && ((*(byte *)(param_1 + 0xb) & 1) == 0)) &&
       ...
       ((*(char *)((*(uint *)(*(int *)(param_2 + 0x24) + 4) & 0xf) + param_1 + 0x11) == '\x01' &&
        ((int)(uint)*(byte *)(*(int *)(param_1 + 0x60) + 10) < (int)(DAT_ram_3fcb7da1 - 1))))) {
      uVar1 = 0;
      *(undefined1 *)(param_1 + 0xd) =
           *(undefined1 *)((DAT_ram_3fcb7da1 - 2 & 0xff) * 0xc + *(int *)(param_1 + 0x70));
