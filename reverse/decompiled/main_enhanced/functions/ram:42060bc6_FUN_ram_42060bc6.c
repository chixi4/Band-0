...
void FUN_ram_42060bc6(undefined4 param_1,int param_2,uint param_3,int param_4,int param_5)

{
  ...
  while( true ) {
    ...
    *(char *)(param_5 + 0xf) = (char)uVar4;
    FUN_ram_4205fdee(param_1,param_5,iVar6);
    FUN_ram_42060b22(iVar6,param_2 + iVar5);
  }
  if ((param_3 & 0xf) != 0) {
    param_4 = uVar1 * 0x10 + param_4;
    *(char *)(param_5 + 0xe) = (char)(uVar1 + 1 >> 8);
    *(char *)(param_5 + 0xf) = (char)(uVar1 + 1);
    FUN_ram_4205fdee(param_1,param_5,param_4);
    uVar4 = 0;
    do {
