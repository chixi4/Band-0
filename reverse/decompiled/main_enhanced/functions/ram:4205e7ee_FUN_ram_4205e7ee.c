...
uint FUN_ram_4205e7ee(int *param_1,undefined4 param_2,undefined4 param_3,uint *param_4,uint *param_5
                     )

{
  ...
  for (; param_1 != (int *)0x0; param_1 = (int *)*param_1) {
    ...
    iVar3 = FUN_ram_4205e786(param_1[1],uVar1);
  ...
  iVar3 = FUN_ram_420523aa(param_2);
  iVar4 = FUN_ram_420523aa(param_3);
