...
void FUN_ram_4204d7c2(int param_1,int *param_2)

{
  ...
  do {
    ...
    iStack_e4 = 0;
    while (iVar3 = FUN_ram_4204cd30(iVar2,0xff,0x42,0,&iStack_e4,&uStack_e0,0xff), iVar3 == 0) {
      iVar3 = *param_2;
      FUN_ram_4039c11e(auStack_c0,&uStack_e0,0x20);
      ...
      for (; iVar3 != 0; iVar3 = *(int *)(iVar3 + 4)) {
        iVar4 = FUN_ram_4039c5aa(auStack_38,iVar3 + 8,0xf);
        if ((((iVar4 == 0) && (*(char *)(iVar3 + 0x18) == cVar1)) &&
            (*(byte *)(iVar3 + 0x1a) <= uVar5)) &&
           (uVar5 < (uint)*(byte *)(iVar3 + 0x19) + (uint)*(byte *)(iVar3 + 0x1a)))
        goto LAB_ram_4204d8cc;
      }
      FUN_ram_4204d0c6(iVar2,uStack_e0,uStack_df,auStack_d8,uStack_dd,0xff);
LAB_ram_4204d8cc:
