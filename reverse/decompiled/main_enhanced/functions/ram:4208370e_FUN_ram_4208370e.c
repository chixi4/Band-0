...
undefined4 FUN_ram_4208370e(int param_1)

{
  ...
  if (param_1 != 0) {
    ...
    if (iVar6 == 0) {
      ...
      FUN_ram_4039c11e(param_1,iVar6 + 8,0x20);
      FUN_ram_4039c11e(param_1 + 0x20,iVar6 + 0x2f,0x40);
      *(uint *)(param_1 + 0x60) = (uint)*(byte *)(iVar6 + 0x35c);
      *(undefined1 *)(param_1 + 100) = *(undefined1 *)(iVar6 + 0x92);
      FUN_ram_4039c11e(param_1 + 0x65,iVar6 + 0x93,6);
      ...
      *(uint *)(param_1 + 0x8c) = (uint)*(byte *)(iVar6 + 0x418);
      FUN_ram_4039c11e(param_1 + 0x97,iVar6 + 0x451,0x20);
      FUN_ram_42083512();
      uVar7 = 0;
    }
    return uVar7;
