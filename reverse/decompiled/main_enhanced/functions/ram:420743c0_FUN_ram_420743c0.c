...
undefined4 FUN_ram_420743c0(int *param_1,int param_2,int param_3)

{
  ...
  if ((param_1 == (int *)0x0) || (iVar9 = *param_1, iVar9 == 0)) {
    FUN_ram_4207a038(1,0x800,1,&DAT_ram_3c0fe428,&DAT_ram_3c0c4114,0x5fb);
    do {
                    /* WARNING: Do nothing block with infinite loop */
    } while( true );
  }
  (*(code *)&SUB_ram_40011fd0)(_DAT_ram_3fcc4014 != iVar9,aiStack_28);
  ...
  if (*(int *)(iVar9 + 0x120) == 1) {
    iVar11 = FUN_ram_42079e84(param_2);
  }
  ...
  if ((uVar7 & 1) != 0) {
    ...
    *(byte *)(iVar10 + 1) = bVar1 | 0x40;
    if ((*param_1 == _DAT_ram_3fcc4014) && (_DAT_ram_3fcc41c4 != 0)) {
LAB_ram_42074484:
      FUN_ram_42074316(param_1,param_2);
    }
    else if ((iVar9 == _DAT_ram_3fcc4018) && (*(char *)((int)param_1 + 0x2f9) != '\0')) {
      if ((*(byte *)(iVar10 + 4) & 1) == 0) goto LAB_ram_42074484;
      *puVar6 = uVar7 & 0xfffffffe;
      *(byte *)(iVar10 + 1) = bVar1 & 0xbf;
      iVar5 = FUN_ram_42078dde(param_2);
      if (iVar5 != 0) {
  ...
  *puVar6 = ((uint)uVar3 + (uint)uVar2 & 0xfff) << 0xc | *puVar6 & 0xff000fff;
  if (*(int *)(iVar9 + 0x120) != 1) goto LAB_ram_420744e4;
  if ((param_3 - 0xa0U & 0xffffffdf) == 0) {
    if ((*(byte *)(iVar10 + 4) & 1) == 0) {
      if (param_1 == *(int **)(iVar9 + 0xec)) goto LAB_ram_420744e0;
      ...
      *(undefined1 *)((int)param_1 + 0x2fb) = 1;
      ...
      (**(code **)(_DAT_ram_3fcdfdd8 + 0xe0))
                (param_1 + 0x4f,
                 (uint)*(byte *)(*(int *)(gp + -0xb4) + 0x50b) *
                 (uint)*(ushort *)(*(int *)(gp + -0xb4) + 0x3f8) * 3,0);
      if ((*(byte *)(iVar10 + 4) & 1) != 0) goto LAB_ram_42074558;
    }
    else {
LAB_ram_42074558:
...
LAB_ram_420744e0:
  if ((iVar11 != 0) && ((param_1[3] & 0x10U) != 0)) {
    uVar4 = FUN_ram_42079bba(param_1,param_2);
    return uVar4;
  }
LAB_ram_420744e4:
