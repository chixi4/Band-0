...
undefined4 FUN_ram_4207c272(int param_1,int param_2)

{
  ...
  if (param_1 == 0) {
    FUN_ram_4207a038(1,0x800,1,&DAT_ram_3c0fe744,&DAT_ram_3c0c426c,0x3aa);
    do {
  ...
  iVar8 = (_DAT_ram_3fcc2a10 + 1) % 0x3f;
  ...
  *(char *)(piVar3 + 0xc) = (char)iVar8;
  ...
  (**(code **)(_DAT_ram_3fcdfdd8 + 0xec))(piVar4,0x4206b538,piVar3);
  ...
  *(ushort *)(piVar3 + 0xb) = *(ushort *)(piVar3 + 0xb) | 2;
  ...
  _DAT_ram_3fcc2a10 = iVar8;
  uVar5 = FUN_ram_4208cfae(param_1,3,0,&uStack_2c);
  return uVar5;
}
