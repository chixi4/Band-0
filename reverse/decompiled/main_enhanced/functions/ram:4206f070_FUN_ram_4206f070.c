...
undefined4
FUN_ram_4206f070(int param_1,uint param_2,undefined4 param_3,uint param_4,undefined1 *param_5)

{
  ...
  if (param_1 == 0) {
    ...
    uVar2 = FUN_ram_4206eece();
    if (uVar2 == 0) {
      return 0xffffbf80;
    }
    iVar3 = FUN_ram_42073818(param_1,auStack_24,&iStack_28);
    if (iVar3 != 0) {
      return 0xffffbf80;
    }
    if (uVar2 != param_2) {
  ...
  *puVar5 = 0;
  if (param_1 == 0) {
    FUN_ram_4039c11e(puVar5 + 1,param_3,param_2);
  }
  else {
    puVar5[1] = 0x30;
    puVar5[3] = 0x30;
    ...
    puVar5[5] = 6;
    puVar5[6] = cVar1;
    iVar4 = FUN_ram_4039c11e(puVar5 + 7,auStack_24[0],iStack_28);
    puVar5 = (undefined1 *)(iVar4 + iVar3);
    *puVar5 = 5;
    puVar5[2] = 4;
    puVar5[1] = 0;
    puVar5[3] = (char)param_2;
    iVar3 = FUN_ram_4039c11e(puVar5 + 4,param_3,param_2);
    if (param_5 + param_4 != (undefined1 *)(iVar3 + param_2)) {
      FUN_ram_4206d7da(param_5,param_4);
      return 0xffffbf80;
    }
  }
  return 0;
