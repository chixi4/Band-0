...
void FUN_ram_42096114(uint param_1,uint param_2,int param_3,byte *param_4)

{
  ...
  if ((param_2 & 3) == 0) {
LAB_ram_4209616a:
    if ((uVar4 & 3) == 0) goto LAB_ram_4209618c;
    iVar6 = 0x368;
  }
  else {
    ...
    if (uVar4 != 0) {
      ...
      FUN_ram_4039c11e(uVar4,param_2,param_3);
      goto LAB_ram_4209616a;
    }
    iVar6 = 0x35c;
  }
  FUN_ram_4207a038(6,0x2000,2,&DAT_ram_3c102000 + iVar6);
LAB_ram_4209618c:
  ...
  *(uint *)(iVar5 + 0x60048404) =
  ...
  FUN_ram_4039c11e(iVar5 + 0x60048408,uVar4,uVar8);
  if (uVar4 == param_2) {
    return;
  }
  thunk_FUN_ram_40390634(uVar4);
  return;
}
