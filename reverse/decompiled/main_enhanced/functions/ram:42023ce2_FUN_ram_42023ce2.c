...
int FUN_ram_42023ce2(int param_1,int param_2,undefined1 param_3,undefined4 param_4,
                    undefined2 param_5)

{
  ...
  if (((_DAT_ram_3fcc518c == param_1) && (*(char *)(_DAT_ram_3fcc518c + 0x26) != '\0')) &&
    ...
    if (iVar1 == 0) {
      ...
      aiStack_24[0] = 0;
      iVar2 = FUN_ram_42023b5a(param_3,3,iVar2 + 0x2b);
      if ((iVar2 != 0) && (aiStack_24[0] = FUN_ram_4202d4f8(param_4,param_5), aiStack_24[0] != 0)) {
        iVar2 = FUN_ram_4202aa60(*(undefined2 *)(iVar2 + 0xc),aiStack_24[0]);
        return -(uint)(iVar2 != 0);
      }
