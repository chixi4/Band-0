...
int FUN_ram_420afe60(undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  uVar1 = FUN_ram_420b1562(param_1,param_3,auStack_24);
  if ((uVar1 != 0) && (iVar2 = FUN_ram_420afd4a(param_1), iVar2 != 0)) {
    iVar3 = FUN_ram_42013eae(param_1,param_2,auStack_24[0],0x1b6);
    if (-1 < iVar3) {
      ...
      *(undefined4 *)(iVar2 + 0x30) = 0x420a0084;
      if ((uVar1 & 0x100) != 0) {
        thunk_FUN_ram_420b008c(param_1,iVar2,0,2);
      }
