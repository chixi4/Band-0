...
undefined4 FUN_ram_4206da96(uint *param_1,undefined4 param_2)

{
  ...
  FUN_ram_4206da7e(param_1,&DAT_ram_3c0f9cb0,iVar3 - (uVar1 & 0x3f));
  FUN_ram_4206d932(param_1,&uStack_18);
  FUN_ram_4039c11e(param_2,param_1 + 2,0x14);
  return 0;
}
