...
int FUN_ram_4206eaf2(int *param_1,byte *param_2,uint param_3,uint param_4,uint param_5,uint param_6,
...

{
  ...
  iVar3 = FUN_ram_4206e970(param_1,param_2,&iStack_34,0x30);
  if (iVar3 == 0) {
    pbVar2 = (byte *)*param_1;
    if (param_2 == pbVar2 + iStack_34) {
      while (pbVar2 < param_2) {
        *param_1 = (int)(pbVar2 + 1);
        ...
        iVar4 = FUN_ram_4206e8f6(param_1,param_2,&iStack_34);
        iVar1 = iStack_34;
        if (iVar4 != 0) {
          return iVar4;
        }
