...
short FUN_ram_42092eac(int param_1)

{
  ...
  if (uVar10 < 4) {
    uVar14 = (uint)(byte)(&DAT_ram_3c0fab94)[uVar10];
    uVar10 = (uint)(byte)(&DAT_ram_3c0fab98)[uVar10];
    ...
    *puVar18 = uVar16 | 0x80;
    ...
    for (uVar16 = ((uVar7 + local_88) - uVar10) - iVar17;
      ...
      iVar15 = FUN_ram_4039f30c(0,10,uVar11 + uVar5);
      if (iVar15 == 0) goto LAB_ram_4209305a;
      FUN_ram_4039c11e(*(int *)(*(int *)(iVar15 + 4) + 4) + uVar14,
    ...
    if (uVar9 == 0x200) {
      ...
      FUN_ram_42092dfe(iVar13,auStack_a0 + iVar4);
      FUN_ram_4039c11e((int)&local_90 + iVar4,iVar13 + iVar19,local_8c);
      uVar9 = local_8c;
      uVar16 = local_90;
      *(undefined1 *)((int)&local_90 + iVar17 + iVar4 + -0x10) = 0x5a;
      ...
      iVar17 = FUN_ram_42092494(&local_79,&local_78,&local_74,&local_70,
                                *(byte *)(*(int *)(param_1 + 0x24) + 0x10) & 0xbf,auStack_60,0x20);
      if (iVar17 != 0) goto LAB_ram_4209305a;
      uVar16 = FUN_ram_42092b30(auStack_48);
      uVar9 = FUN_ram_42092b30(auStack_44);
      uVar11 = 0;
      while (uVar11 < uVar5) {
        local_8c = uVar11;
        uVar11 = FUN_ram_42092b30(auStack_a0 + uVar11 + iVar4);
        uVar16 = uVar16 ^ uVar11;
        uVar9 = (uVar16 >> 0xf | uVar16 << 0x11) ^ uVar9;
        iVar17 = uVar16 + uVar9;
        uVar16 = FUN_ram_42092b6a(iVar17);
        uVar9 = uVar9 ^ uVar16;
        uVar16 = iVar17 + uVar9;
      ...
      FUN_ram_42092b4e(&local_68,uVar16);
      FUN_ram_42092b4e(&local_64,uVar9);
    ...
    for (iVar4 = *(int *)(param_1 + 0x20); iVar4 != 0; iVar4 = *(int *)(iVar4 + 0x20)) {
      local_94 = uVar16;
      if (uVar14 != 0) {
        FUN_ram_4039c11e(*(undefined4 *)(*(int *)(iVar4 + 4) + 4),
      ...
      *(int *)(*(int *)(iVar4 + 4) + 4) = iVar17;
      ...
      FUN_ram_4039c11e(iVar17,iVar13,local_84);
      uVar7 = uVar7 + 1;
    ...
    if ((iVar15 != 0) && (iVar17 != 0)) {
      ...
      *(undefined4 *)(iVar15 + 0x20) = 0;
      if ((*(uint *)(iVar13 + 0x10) & 0xf00) == 0x200) {
        FUN_ram_4039c11e(*(int *)(*(int *)(iVar15 + 4) + 4) +
